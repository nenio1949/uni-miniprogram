(function(config) {
	...
	var Qa = Ma && ma("os 10_"),
		...
		Sa = ma("android"),
		Ta = 0;
	Sa && (Ta = parseInt(ba.split("android ")[1]) || 0);
	var Ua = Sa && 4 > Ta;
	Sa && 5 <= Ta || ba.search(/android 4.4/);
	var Va = Sa ? "android" : Ma ? "ios" : wa ? "windows" : Ea ? "mac" : "other",
		Wa = sa && !ca.XMLHttpRequest,
		Xa = sa && !fa.querySelector,
		Ya = sa && !fa.addEventListener,
		Za = sa && ma("msie 9"),
		$a = sa && ma("msie 10"),
		ab = sa && ma("rv:11"),
		bb = Ya || Za,
		...
		fb = ma("alipay") || Sa && eb,
		gb = ma("miuibrowser"),
		hb = ma("micromessenger"),
		ib = ma("mqqbrowser"),
		jb = ma("baidubrowser"),
		chrome = (ma("chrome") || ma("crios")) && !hb && !jb && !ib && !cb && !gb,
		kb = chrome && ma("chromium"),
		lb = chrome && !kb && (30 < parseInt(ba.split("chrome/")[1]) ||
			30 < parseInt(ba.split("crios/")[1])),
		mb = ma("firefox"),
		nb = mb && 27 < parseInt(ba.split("firefox/")[1]),
		ob = (Ea || Ma) && ma("safari") && ma("version/"),
		pb = Ea && ob && 7 < parseInt(ba.split("version/")[1]),
		qb = Ma && ma("aliapp"),
		rb = Ma && (!ib && !eb && !hb && !chrome && !mb && !ob || qb && !eb),
		sb = Sa || Ma || Da || ma("mobile"),
		tb = "ontouchstart" in fa,
		ub = ca.navigator && ca.navigator.msPointerEnabled && !!ca.navigator.msMaxTouchPoints,
		vb = ca.navigator && !!ca.navigator.maxTouchPoints,
		wb = !tb && (vb || ub),
		xb = tb || wb,
		yb = function() {
			if (!sb) return ca.devicePixelRatio ||
				1;
		...
		zb = va && (!sb || !!yb && 1 <= yb),
		Ab = sa && "transition" in ga.style,
		Bb = !!fa.createElementNS && !!fa.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect,
		Cb = fa.createElement("canvas"),
		Db = !(!Cb || !Cb.getContext),
		Eb = window.URL || window.webkitURL,
		Fb = !0 !== window.disableWorker && !sa && !cb && !(eb &&
			Sa) && window.Worker && Eb && Eb.createObjectURL && window.Blob,
		Gb = "",
		qa = "",
		Jb = 0,
		Kb = window.forceWebGL ? {
			alpha: !0,
			antialias: !0,
			depth: !0
		} : {
		...
		Lb = function() {
			if (!window.forceWebGL && (!Db || !Fb || rb && qb && !eb)) return !1;
			for (var a = ["webgl", "experimental-webgl", "moz-webgl"], b = null, c = 0; c < a.length; c += 1) {
				try {
					b = Cb.getContext(a[c], Kb)
				} catch (d) {}
				if (b) {
					if (b.drawingBufferWidth !== Cb.width || b.drawingBufferHeight !== Cb.height) break;
					if (window.forceWebGL) return Gb =
						a[c], Jb = Infinity, !0;
					if (!b.getShaderPrecisionFormat || !b.getParameter || !b.getExtension) break;
					Jb = b.getParameter(b.MAX_RENDERBUFFER_SIZE);
					var e = b.getParameter(b.MAX_VIEWPORT_DIMS);
					if (!e) break;
					Jb = Math.min(Jb, e[0], e[1]);
					ob && "mac" === Va && (Jb = Math.min(Jb, 4096));
					e = Math.max(screen.width, screen.height);
					zb && (e *= Math.min(2, window.devicePixelRatio || 1));
					if (e > Jb) break;
		...
		Mb = Lb && (lb || nb || pb) && ("mac" === Va || "windows" === Va) && !sb,
		Nb = !window.Uint8Array || !Db || db || Da || sb && mb || Za || Na || Ja || Ka || Ua || ma("gt-n710") || za,
		Ob = !Nb && !Mb,
		Pb = Mb ? "vw" : Nb ? "d" : Ob ? "dv" : "v",
		Qb = ma("webkit"),
		Rb = "WebKitCSSMatrix" in ca && "m11" in new window.WebKitCSSMatrix,
		Sb = "MozPerspective" in ga.style,
		Tb = "OTransition" in ga.style,
		Ub = Ab || Rb || Sb || Tb,
		Vb = void 0 !== config[8] ? config[8] : !0,
		Wb = void 0 !== config[9] ? config[9] : !0,
		Xb =
		void 0 !== config[10] ? config[10] : !0,
		Yb = void 0 !== config[11] ? config[11] : !0,
		Zb = void 0 !== config[12] ? config[12] : null,
		$b = !Bb && sb && Db,
		ac = !0;
	try {
		if ("undefined" === typeof ca.localStorage) ac = !1;
		else {
			var bc = (new Date).getTime() + "";
			ca.localStorage.setItem("_test", bc);
			ca.localStorage.getItem("_test") !== bc && (ac = !1);
			ca.localStorage.removeItem("_test")
		}
	} catch (cc) {
		ac = !1
	}
	var dc = parseInt(ba.split("chrome/")[1]),
		ec = Vb && Db;
	config.l = {
		Vra: Ga,
		Wra: La,
		size: La ? 100 : Sa ? 200 : 500,
		pz: Ea,
		bAa: wa,
		GD: Ma,
		hFa: Qa,
		...
		Zta: Fa,
		Kv: ac,
		Oi: ec && ac && Yb && !sb && chrome,
		mf: Zb,
		geolocation: sb || sa && !Ya || cb,
		qza: eb,
		sL: eb && !chrome,
		chrome: chrome,
		l3: !0,
	...
	window.AMap ? (window.AMap.version = "1656665904502", window.AMap.wL = {
		xM: function(a) {
			a(fc)
		}
	}) : window.AMap = {
		version: "1656665904502",
		wL: {
			xM: function(a) {
				a(fc)
			}
	...
	fc.Ek = "1656665904502";
	fc.Tu = gc;
	for (var hc = document.head || document.getElementsByTagName("head")[0], ic =
			...
			.replace(/url\((['"]?)(?:\.\.\/)+/g, "url($1" +
				fc[2].split(",")[0] + "/"), jc = null, kc = 0, lc = hc.childNodes.length; kc < lc; kc++)
		if (1 === hc.childNodes[kc].nodeType) {
			jc = hc.childNodes[kc];
			break
		} if (ic)
		if (hc) {
			...
			mc.styleSheet ? mc.styleSheet.cssText = ic : mc.innerHTML = ic;
			jc ? hc.insertBefore(mc, jc) : hc.appendChild(mc)
		} else document.write("<style type='text/css'>" + ic + "</style>");
	var g = g || {
			Ca: {
				Ke: 0,
				mr: [],
	...
	g.c.add = g.BuryPoint.add = function(a, b, c) {
		a.y5 || a.C || !(a = a.CLASS_NAME) || (a = a.replace("AMap.", ""), g.BA.np(a, b, c))
	};
	var nc = {
		lang: 1,
		baseRender: 1,
	...
	g.c.ya = g.BuryPoint.addOptions = function(a, b) {
		if (!a.fva)
			if (b && (b.innerLayer || b.innerOverlay)) a.y5 = !0;
			else {
				a.fva = !0;
				var c = a.CLASS_NAME;
				if (c) {
					...
					g.BA.np(c);
					b = b || {};
					for (var d in b) b.hasOwnProperty(d) && ("Map" === c && d in nc ? g.BA.np(c, d, b[d]) : g.BA
						.np(c, d))
				}
			}
	};
	...
	g.BA = {
		...
		send: function() {
			var a = [],
				b;
			for (b in this.Gj)
				if (this.Gj.hasOwnProperty(b)) {
					var c = this.Gj[b],
						d = [],
						e;
					for (e in c) c.hasOwnProperty(e) && 0 == c[e] && (d.push(e), c[e] = 1);
					d.length && a.push(b + "~" + d.join(","))
				} a.length && (a = ["type=nfl", "k=" + g.o.key, "m=" + (g.l.ba ? 1 : 0), "pf=" + g.l.Fz,
					"v=" + g.o.Xl, "branch=JSAPI", "log=" + a.join("!")
				], a = g.o.Cc + "://webapi.amap.com/count?" +
	...
	g.va = {
		...
		r: function(a, b) {
			...
			void 0 !== b && (b instanceof Array ? (c = b.slice(0), c.type = a) : "string" === typeof b ||
				"number" === typeof b || "boolean" === typeof b ? c.value = b : g.a.GJ(b) ? c.value =
				b : c = g.extend(c, b));
			for (var d = [].concat(this.nf[a]), e = 0; e < d.length; e += 1) d[e].yb && (d[e].yb.call(d[e]
				.cf || this, c), d[e] && d[e].Dj && this.nf[a] && this.nf[a].splice(e, 1));
			return this
		},
		ui: function(a) {
	...
	g.$e = {
		set: function(a, b, c) {
			...
			} else(this.De = this.De || {})[a] = b, c || this.DK(a, b)
		},
		K4: function() {
			var a = {};
			return function(b) {
		...
		get: function(a, b, c) {
			...
			if (e && e[a]) return c = e[a], c[d] ? (a = !1, !0 == c.C ? a = !0 : c.C = !0, b = c[d](b), a ||
				(c.C = !1), b) : c.get(a, b);
			if (!c && this[d]) return a = !1, !0 == this.C ? a = !0 : this.C = !0, b = this[d](b), a || (
				this.C = !1), b;
		...
		zl: function() {
			if (this.Il)
				for (var a in this.Il) this.Il.hasOwnProperty(a) && this.yl(a)
		},
		DK: function(a, b) {
			var c = a + "Changed";
			if (this[c]) this[c](b);
	...
	g.o = {
		...
		key: "ffdb1e8cf24f46b5747e80a049ae4aee",
		Cc: "http",
		...
		zU: "http://webst0{1,2,3,4}.is.autonavi.com/appmaptile?style=6&x=[x]&y=[y]&z=[z]",
		QK: "http://webst0{1,2,3,4}.is.autonavi.com/appmaptile?x=[x]&y=[y]&z=[z]&lang=zh_cn&size=1&scale=1&style=8",
		RK: "http://wprd0{1,2,3,4}.is.autonavi.com/appmaptile?x=[x]&y=[y]&z=[z]&lang=zh_cn&size=1&scl=1&style=8&ltype=11",
		VE: "http://wprd0{1,2,3,4}.is.autonavi.com/appmaptile?lang=[lang]&size=1&style=7&x=[x]&y=[y]&z=[z]",
		yL: "http://vector.amap.com",
		xL: "vdata.amap.com",
		gAa: "ws",
	...
	function oc(a) {
		...
		"https" === b && (g.o.gAa = "wss", g.o.fd = g.o.fd.replace("http", "https"), g.o.QD = g.o.QD.replace("http",
				"https"), g.o.UJ = g.o.UJ.replace("http", "https"), g.o.zU = g.o.zU.replace("http", "https"), g
			.o.QK = g.o.QK.replace("http", "https"), g.o.RK = g.o.RK.replace("http", "https"), g.o.VE = g.o.VE
			.replace("http", "https"), g.o.yL = g.o.yL.replace("http", "https"), g.o.UI = g.o.UI.replace("http",
				"https"));
		...
		d.type = "text/css";
		g.o.Doa = "url(" + b + "://webapi.amap.com/theme/v1.3/openhand.cur),default";
		var e = ".amap-container{cursor:" + g.o.Doa + ";}.amap-drag{cursor:url(" + b +
		...
		g.o.Nc = a[5];
		g.o.Pla = a[6];
		window._AMapSecurityConfig && (window._AMapSecurityConfig.securityJsCode ? (g.o.Xa = window
			._AMapSecurityConfig.securityJsCode, g.o.fv = "") : window._AMapSecurityConfig.serviceHost && (g
			.o.fv = window._AMapSecurityConfig.serviceHost,
			g.o.fd = g.o.fv, b = "", b = (b = "https" === g.o.fd.split(":")[0] ? g.o.fd.replace(
				/https:\/\/\S+?\//g, "") : g.o.fd.replace(/http:\/\/\S+?\//g, "")) && b.split("/")[0], c =
			window.location.hostname, "_AMapService" !== b && ("127.0.0.1" === c || "localhost" === c ?
				window.alert(
					"\u4f7f\u7528 JSAPI \u5b89\u5168\u6a21\u5f0f\uff0c\u4ee3\u7406\u670d\u52a1\u8bf7\u4ee5_AMapService \u4f5c\u4e3a\u4e00\u7ea7\u8def\u7531"
					) : "undefined" !== typeof console && console.log(
					"<AMap JSAPI> \u4f7f\u7528 JSAPI \u5b89\u5168\u6a21\u5f0f\uff0c\u4ee3\u7406\u670d\u52a1\u8bf7\u4ee5_AMapService \u4f5c\u4e3a\u4e00\u7ea7\u8def\u7531"
					))));
		g.o.TQ = a[13];
		pc()
	}
				...
				for (var a = window.localStorage.length; 0 <= a; a -= 1) {
					...
					if (b && "_AMap_" === b.slice(0, 6)) {
						var c = window.localStorage.getItem(b),
							c = JSON.parse(c || {});
						"_AMap_anole" === b ? c.version !== g.l.mf && window.localStorage.removeItem(b) :
							"_AMap_data.tileKeys" === b ? c.vdataVer === g.l.mf && c.apiVer === g.o.Ek || window
							.localStorage.removeItem(b) : c.version !== g.o.Ek && window.localStorage.removeItem(b)
					}
				}
		} catch (d) {}
	}
	window.AMap && window.AMap.wL && window.AMap.wL.xM && window.AMap.wL.xM(oc);
	g.Nm = {
		Ru: Math.PI / 180,
		kwa: 180 / Math.PI,
		RQ: 6378137
			...
			gra: function(b) {
				...
				if (g.l.ba) {
					...
					d.push("&wp=" + encodeURIComponent(
						"viewMap?sourceApplication=jsapi_q&dev=0&poiname=" + b.name + "&lat=" +
						b.y + "&lon=" + b.x));
					d.push("&mo=" + encodeURIComponent(g.o.Mv + "?q=" + c.join(",") +
						"&callapp=0&sourceApplication=jsapi_q"));
					return d.join("")
				}
				return g.o.qK + "?q=" + c.join(",") + "&src=jsapi_q"
			},
			w4: function(b) {
				b.name = a(b.name);
				...
				return g.o.qK + "?p=" + c.join(",") + "&src=jsapi_p"
			},
			u4: function(b) {
				if (g.l.ba) {
				...
				return g.o.qK + "/detail/" + b.id + "?src=jsapi_detail"
			},
			MR: function(b) {
				b.sname = a(b.sname);
				"" === b.sname &&
				...
				return g.o.qK + "?r=" + c.join(",") + "src=jsapi_r_" + b.t
			},
			ot: function(a) {
	...
	g.a = {
		...
		kR: {
			...
			stop: function(a) {
				a.ioa = new Date - a.startTime;
				this.cancel(a);
				a.kR = Math.round(1E3 / (a.ioa / (a.mt.length + 1)))
			}
		},
		H4: function(a, b, c) {
		...
		eb: function(a) {
			if ("object" === typeof a && null !== a) {
				if (a.X6 || this.kk(a, "Float32Array") || this.kk(a, "Uint16Array")) return a;
		...
		Gxa: "function" === typeof Object.setPrototypeOf ? Object.setPrototypeOf : function(a, b) {
		...
		am: function(a) {
			...
			if (0 == a.indexOf("#")) {
				...
				if (9 == a.length) return a = a.substr(1), this.Yk(a.substr(6) + a.substr(0, 6))
			} else {
				if (0 == a.indexOf("rgb(")) return a = this.cxa(a), a.push(1), a;
		...
		Hna: function(a, b, c) {
			return "function" == typeof b ? this.MP(a, !0, this.Cma(b,
				c, 1)) : this.MP(a, !0)
		},
		MP: function(a, b, c, d, e, f, h) {
			var k;
			c && (k = e ? c(a, d, e) : c(a));
			if (void 0 !== k) return k;
			if (!this.Q5(a)) return a;
			if (d = this.isArray(a)) {
				if (k = this.psa(a), !b) return this.kma(a, k)
			} else {
				var l = Object.prototype.toString.call(a),
					m = "[object Function]" == l;
				if ("[object Object]" == l || "[object Arguments]" == l || m && !e) {
					if (k = this.qsa(m ? {} : a), !b) return this.tma(k, a)
				} else return e ? a : {}
			}
			f || (f = []);
			h || (h = []);
			...
			f.push(a);
			h.push(k);
			(d ? this.lma : this.yma)(a, function(d, e) {
				k[e] =
					g.a.MP(d, b, c, e, a, f, h)
			});
			return k
		},
		tma: function(a, b) {
			return null == b ? a : this.wma(b, Object.keys(b), a)
		},
		Q5: function(a) {
			var b = typeof a;
		...
		yma: function(a, b) {
			return g.a.joa()(a, b, Object.keys)
		},
		Dya: function(a) {
			return g.a.Q5(a) ? a : Object(a)
		},
		wma: function(a, b, c) {
			c || (c = {});
		...
		ypa: "data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=",
		...
		c7: function(a) {
			return "undefined" !== typeof JSON && JSON.stringify ? g.a.z9(JSON.stringify(a)) : null
		},
		GHa: function(a, b) {
		...
		iepngFix: function(a) {
			...
			window.DD_belatedPNG && this.GS ? setTimeout(function() {
				b()
			}, 100) : this.GS || g.ub.load("AMap.FixPng", b)
		},
		Ka: function(a) {
			if (g.a.isArray(a))
				if (g.a.isArray(a[0]))
	...
	g.a.sU = window.requestIdleCallback ? function(a, b) {
	...
	g.a.bQ = window.cancelIdleCallback ? function(a) {
		...
		a.a.GR = function(d, e) {
			...
			f.getCurrentPosition(function() {
				...
				l || (clearTimeout(k), k = void 0, 2 === b.code && 0 < b.message.indexOf(
					"permission") ? a.ub.load("AMap.GeoRemoteLoc", function() {
					d(null, a.saa, h)
				}) : d(null, f))
			}, {
				timeout: 1E3
	...
	(function(a) {
		var b = a.da.extend({
			...
			oga: function() {
				a.Mj && a.Mj.h("vecTileParsed.buildings", this.Vfa, this)
			},
			J5: function(a) {
				return a.map.HZ
			},
			Tqa: function(a) {
				return this.J5(a) ? a.map.RN : null
			},
			Bxa: function(a, b) {
				if (b) {
					var e = b.map;
					e && (e.RN ? e.RN.toString() : "") !== (a ? a.toString() : "") && (e.RN = a ||
					[], e.set("display", 0))
				}
			},
			Y8: function(a, b) {
				if (b) {
					var e = b.map;
					e && e.HZ !== a && (e.HZ = a, e.set("display", 0))
				}
			},
			RBa: function() {},
			DZ: function(a, b) {
			...
			D3: function(b) {
				...
				for (var d = 0, e = b.length; d < e; d++)
					if (a.q.fi && b[d] instanceof a.q.fi && b[d].ha && b[d].ha.length && (-1 !== b[
							d].ha.indexOf("building") || -1 !== b[d].ha.indexOf("poilabel")) && b[d]
						.Ra) {
			...
			qqa: function(a) {
				if (a = this.D3(a)) {
					...
					for (var b = [], e = 0, f = a.length; e < f; e++) {
						var h = a[e];
						h.qe && h.qe.uf && this.DZ(h.qe.uf, b)
					}
					return b
				}
			},
	...
	(function(a) {
		...
		function d(a) {
			...
			var c = [],
				d = null,
				e = null;
			for (d in this._wkHandlers) - 1 !== d.indexOf("_def_") && (e = this._wkHandlers.$Fa = d);
			...
			a.addEventListener("message", function(d) {
				...
				var f = d.data;
				d = f.Vwa || [f];
				for (var h = d.length, n = 0, p = Date.now() - f.bA, t = [], f = 0; f < h; f++) b(d[f],
					e)
			}, !1)
		}
		...
		function e(d, h) {
			...
			this.RB(null);
			this.w.lazy || this.oy();
			a.Jra || !1 === this.w.hostWorker || (a.Jra = this);
				...
				if (!a.eca) {
					...
					a.addEventListener("message", function(a) {
						...
						for (var c = 0, d = a.length; c < d; c++) {
							...
							a: {
								f = e.Qz;
								for (var h = !e.dl, k = 0, v = b.length; k < v; k++) {
									var w = b[k];
									if (f === w.Qz) {
										h || b.splice(k, 1);
										f = w;
		...
		a.extend(e.prototype, {
			...
			Au: function(a) {
				this.cka && this.Sp.push.apply(this.Sp, a)
			},
			nT: function(a) {
				this.B0 ? a.apply(null, this.B0) : (this.Tx || (this.Tx = []), this.Tx.push(a))
			},
			oy: function(b) {
				var c = this;
				if (!c.IX) {
					c.IX = !0;
					var d = function(d, e) {
						d && a.l.IS && console.warn(d);
						c.lka.call(c, d, e);
						b && b(d, e)
					};
					a.l.IS ? this.Zja(function(a, b) {
						b ? this.vga(b, function(a, c) {
							a ? d(a) : (this.RB(c), this.BP = c, this.Sp.length = 0,
								this.mo = null, d(null, {
									Ama: b,
									dAa: c
								}))
			...
			xf: function(b, c) {
				...
				f.RB(null, h);
				f.nT(function(a) {
					a ? d(a) : f.BP ? (a = f.SY(c, f.DN(f.YA, b), !0), f.BP.sendMessage(e
						.UR + ":injectCode", a,
						function(a, b) {
							a || f.RB(f.BP, h);
							d(a, b)
			...
			Xca: function(a) {
				var b = {},
					c;
				for (c in a) a.hasOwnProperty(c) && this.nX(c, a[c], b);
				return b
			},
			nX: function(a, b, c) {
				b = b.call(null, !1);
				for (var d in b) b.hasOwnProperty(d) && (c[a + ":" + d] = b[d], a === this.oG && (c[
					d] = b[d]))
			},
			RB: function(a, b) {
				if (!b) this.mo || (this.mo = this.Xca(this.EG)), b = this.mo;
				else if (this.mo)
					for (var c in b) b.hasOwnProperty(c) && (this.mo[c] = b[c]);
				for (c in b)
					if (b.hasOwnProperty(c)) {
						var d = b[c];
						"function" === typeof d && (this[c] = this.vfa(c,
							d, a))
					} this.cka = !!a
			},
			SY: function(a, b) {
			...
			Zja: function(a) {
				...
				for (d in this.EG)
					if (this.EG.hasOwnProperty(d)) {
						var f = this.SY(this.EG[d], this.DN(b, d));
						f && c.push(f)
				...
				c && c !== r ? c.nT(function(b, c) {
					b ? a.call(r, b) : c.dAa.sendMessage(e.UR + ":injectCode", h, function(
						b) {
						b ? a.call(r, b) : a.call(r, null, c.Ama)
					})
				}) : a.call(r, null, r.pla(h))
			},
			pla: function(b) {
			...
			vga: function(a, b) {
				...
				c.gla(a);
				var d = this.Qda(a);
				if (e.vda) b.call(c, null, {
					sendMessage: d
				});
				else {
					e.vda = !0;
					var f = [c.LY() + ":checkup", Math.random().toFixed(5) + "", Math.round(1E3 *
		...
		if (!g.VL) {
			...
			b.send = function(b) {
				var c = d.Cc + "://webapi.amap.com/count?",
					...
					l = g.a;
				b.params && b.params.rs && !b.params.type && (b = a.DD[b.id].time, delete b.w5, k = g
					.extend(k, b));
				b = [];
					...
					return {
						...
						yh: function(a, b) {
							var e = a.Od,
								f = a.Je,
								h = "building" === a.ha[0];
							(f && e !== this.tx.oE && this.tx.oE || !f && !h && e !== this.tx
								.pk && this.tx.pk) && this.Nla(!!f);
							f ? this.tx.oE = e : h || (this.tx.pk = e);
							this.sta(a, b)
						},
						Nla: function(a) {
							if (a) this.iX();
							else if (!a && Object.keys(this.Sk).length)
								for (var b in this.Sk) this.Sk.hasOwnProperty(b) &&
									(a = this.Sk[b], a.Ot || a.abort())
						},
						Mya: function() {
							this.Tt > this.f_ && this.dU(Object.keys(this.Wj).slice(0, Math
								.floor(this.f_ / 2)))
						},
						dU: function(a) {
						...
						PC: function(a) {
							...
							e.Oq = "";
							e.AE = [(new Date).getTime() + "_" + Math.random(), a ? 1 : 0, b
								.join("|")
							].join("-");
							return e
						},
						...
						sta: function(a, b) {
											...
											if (t[n]) {
												...
												if (E.length) {
													var C = E[0].split("-").slice(0, -1).join(
														"/");
													p.Wj[C] ? p.Wj[C].push(E) : (p.Wj[C] = [E],
														p.Tt++);
													m && (p.Wj[C].YZ = !0)
												}
											}
										} else p.Ws(p.extend({}, a, {
											fF: t,
											Od: h,
											Dn: m,
											AS: !0
							...
							if (!this.b5(a, function(a, b) {
								...
								var n = 0,
									p = this,
									q = this.PC(a);
								k ? this.ro.push(q) : (this.Sk[q.AE] = q, q.Jb = l, q.Nc = b);
								var r = !1;
								q.onreadystatechange = function() {
									if (4 === q.readyState && 0 === q.status) q.Ot || (q
										.Ot = !0, f.Ml(l, b), q.onreadystatechange =
										null, k ? f.G0(q) : delete f.Sk[q.AE]), q = null;
									else if (!q.Ot)
										if (3 === q.readyState) {
						...
						bE: function(a) {
							function b(d, p, r) {
								...
								if (d && "loaded" !== d.status && -1 !== m.indexOf(t))
									if ("limg" === t) p = h[1], d.td = p, "string" === typeof p
										.b && (p.b = w.cB(p.b)), r = "", (r = "object" ===
						...
						G0: function(a) {
							for (var b = this.ro.length - 1; 0 <= b; b--) this.ro[b] === a &&
								this.ro.splice(b, 1)
						},
						kga: function(a) {
							for (var b = 0, e = this.ro.length; b < e; b++)
								if (this.ro[b] === a) return !0;
							return !1
						},
						dC: function() {
							return Object.keys(this.Sk).length ? !0 : !1
						},
						iX: function() {
							if (this.ro.length) {
	...
	g.f = {
		...
		JD: function(a, b, c) {
			return a.parentNode == b ? !0 : a.parentNode && a.parentNode !== document.body && !g.f.An(a
				.parentNode, c) ? g.f.JD(a.parentNode, b) : !1
		},
		No: function(a) {
			if (!a) return [0, 0];
			var b = a.offsetWidth,
		...
		nJ: function(a) {
			if (a) return new g.zd(a.clientWidth || document.body.clientWidth, a.clientHeight || (g.l.Gs ?
		...
		TR: function(a) {
			...
			do {
				...
				b -= d.scrollTop || 0;
				c -= d.scrollLeft || 0;
				g.f.Zoa() || !g.l.D$ && !k || (c += d.scrollWidth - d.clientWidth, k && "hidden" !== g.f.$c(
						d, "overflow-y") && "hidden" !== g.f.$c(d, "overflow") &&
					(c += 17));
				d = d.parentNode
			} while (d);
			return new g.H(c, b)
		...
		Zoa: function() {
			g.f.jea || (g.f.jea = !0, g.f.iea = "ltr" === g.f.$c(document.body, "direction"));
			return g.f.iea
		},
		...
		d3: function() {
			...
			this.fja || (this.fja = document.onselectstart, document.onselectstart = g.a.z3)
		},
		q3: function() {},
		Fya: function(a,
			b, c) {
		...
		Wa: function(a, b) {
			a && b && (a.classList && a.classList.add ? a.classList.add(b) : g.f.An(a, b) || (a.className +=
				(a.className ? " " : "") + b))
		},
		uxa: function(a, b) {
			a && (a.className = b || "")
		...
		JEa: function(a, b) {
			return g.f.I4(b.add(b.Pd(-1 * a))) + (" scale(" + a + ") ")
		},
		c9: function(a, b, c) {
			a.bj = b;
			!c && g.l.TH ? (b = g.f.I4(b), c = a.style[g.f.qg].split("rotate"), 1 < c.length ? (c[0] = b, a
				.style[g.f.qg] = c.join("rotate")) : a.style[g.f.qg] = b, g.l.I6 && (a.style
		...
		rotate: function(a, b, c) {
			...
			d ? (a.style[d] = "" + (" rotate(" + b + "deg)"), a.style[g.f.qt[d] + "-origin"] = c.x + "px " +
		...
		E4: function(a, b, c) {
			...
			return d ? g.f.qt[d] + ":" + ("" + (" rotate(" + b + "deg)")) + ";" + (g.f.qt[d] + "-origin:" +
				c.x + "px " + c.y + "px") : ""
		},
		zm: function(a, b, c) {
			a.width = b;
	...
	(function() {
		var a = g.f.$U(["userSelect", "WebkitUserSelect", "OUserSelect", "MozUserSelect", "msUserSelect"]),
			b;
		g.extend(g.f, {
			d3: function() {
	...
	g.f.qg = g.f.$U(["WebkitTransform", "OTransform", "MozTransform", "msTransform", "transform"]);
	g.f.qt = {
		transform: "transform",
	...
	g.f.LF = g.f.$U(["webkitTransition", "transition", "OTransition", "MozTransition", "msTransition"]);
	g.f.dBa = "webkitTransition" === g.f.LF || "OTransition" === g.f.LF ? g.f.LF + "End" : "transitionend";
	g.F = {
		h: function(a, b, c, d) {
			function e(b) {
				b = b || window.event;
			...
			var f = g.a.zb(a) + "_" + g.a.zb(c) + "_" + g.a.zb(d || a),
				h = b + f;
			if (a[h]) return this;
			var k = b;
			g.l.dR && "mousewheel" === b && (b = "DOMMouseScroll");
			...
			if (g.l.R7 && 0 === b.indexOf("touch")) return a[h] = e, this.Vla(a, b, e, f);
			g.l.Uf && "dblclick" === b && this.Tla && this.Tla(a, e, f);
		...
		G: function(a, b, c, d) {
			...
			var e = a[d];
			g.l.dR && "mousewheel" === b && (b = "DOMMouseScroll");
			!g.l.Gs || "mouseover" !== b && "mouseout" !== b || (b = "mouseover" === b ? "mouseenter" :
				"mouseleave");
			g.l.R7 && -1 < b.indexOf("touch") ? this.Bwa(a, b, c) : g.l.Uf && "dblclick" === b && this.xwa ?
				this.xwa(a, c) :
		...
		dya: function(a) {
			var b = g.F.$la;
			g.l.Uf && (g.F.h(a, "touchstart", b, this), g.F.h(a, "touchmove", b, this), g.F.h(a, "touchend",
				b, this));
			g.l.ba || (g.F.h(a, "mousedown", b, this), g.F.h(a, "mouseup", b, this), g.F.h(a, "mousemove",
				b, this), g.F.h(a, "mousewheel", b, this));
			g.l.HT && (g.F.h(a, "pointerdown", b, this), g.F.h(a, "pointerup", b, this), g.F.h(a,
				"pointermove", b, this));
			g.l.K6 && (g.F.h(a, "MSPointerDown", b, this), g.F.h(a, "MSPointerUp", b, this), g.F.h(a,
		...
		txa: function(a) {
			return a && a.getBoundingClientRect ? (a.tM = a.getBoundingClientRect(), a.UW = [a.clientLeft, a
				.clientTop
			], !0) : !1
		},
		uza: function(a) {
			a.tM && (a.tM = null, a.UW = null)
		},
		Ppa: function(a, b) {
			var c = b.tM || b.getBoundingClientRect(),
				d = b.UW || [b.clientLeft, b.clientTop];
			return new g.H(a.clientX - c.left - d[0], a.clientY - c.top - d[1])
		},
		mm: function(a, b) {
			if (b && b.getBoundingClientRect) return this.Ppa(a, b);
			var c = document.body,
				d = document.documentElement,
				c = new g.H(g.l.Uf ? a.pageX : a.clientX + (c.scrollLeft || d.scrollLeft), g.l.Uf ? a
					.pageY : a.clientY + (c.scrollTop || d.scrollTop));
			return b ? c.bb(g.f.TR(b)) : c
		},
		O5: function(a) {
	...
	g.extend(g.F, {
		...
		Vla: function(a, b, c, d) {
			switch (b) {
				case "touchstart":
					return this.Yla(a, b, c, d);
				case "touchend":
					return this.Wla(a, b, c, d);
				case "touchmove":
					return this.Xla(a, b, c, d)
			}
		},
		Po: function(a) {
			if (g.l.HT) return a;
		...
		Yla: function(a, b, c, d) {
			...
			this.j_ || (a = function(a) {
					for (var b = 0; b < f.length; b += 1)
						if (f[b].pointerId === a.pointerId) {
							f.splice(b, 1);
							break
						}
				}, document.documentElement.addEventListener(this.Po("pointerup"), a, !1), document
				.documentElement.addEventListener(this.Po("pointercancel"), a, !1), this.j_ = !0);
			return this
		},
		...
		Bwa: function(a, b, c) {
			...
			switch (b) {
				...
				case "touchmove":
					...
					break;
				case "touchend":
					a.removeEventListener(this.Po("pointerup"), c, !1), a.removeEventListener(this.Po(
						"pointercancel"), c, !1)
			}
			return this
		}
	...
	(function() {
		function a(a) {
			...
			b.eX = e(function() {
				var c = b.Dp;
				if (c && c.Cp)
					for (var d = 0; d < c.Cp.length; d += 1) c.Cp[d].call(c, a)
			})
		}
		...
		g.extend(g.F, {
			Zla: function(e, f) {
				if (!e.Cp)
					if (e.Cp = [], c) e.Dp = e, e.attachEvent("onresize", a);
					else {
			...
			TGa: function(b, d) {
				...
				b.Cp.length || (c ? b.detachEvent("onresize", a) : (b.Dp.contentDocument.defaultView
	...
	g.ub = {
		...
		Gg: function(a, b) {
			...
			for (f = 0; f < e.length; f += 1) this.$Q(e[f], c)
		},
		KD: function(a) {
			for (var b = 0; b < a.length; b += 1)
				if (1 !== this.SC(a[b]).status) return !1;
			return !0
		},
		$Q: function(a, b) {
			var c = this.SC(a);
			if (1 === c.status) b && b();
				...
				try {
					if (g.l.Kv && window.localStorage) {
						var d = window.localStorage["_AMap_" +
							a];
						d && (d = JSON.parse(d), d.version === g.o.Ek ? (window._jsload_(a, d.script, !0), d
				...
				if (0 === c.status) {
					...
					f.ZS || (f.ZS = 1, window.setTimeout(function() {
						f.ZS = 0;
						var a = f.mua + "/modules?v=" + g.o.Xl + "&key=" + g.o.key + "&m=" + f
							.Ez.join(",") + "&vrs=" + g.o.Ek;
						g.ub.Rt(f.Ez.join(","));
						f.Ez = [];
						c.VK = f.Dta(a)
		...
		load: function(a, b) {
			...
			if (c) {
				...
				for (var f = 0, c = function() {
						f += 1;
						f === d.length && b && b()
					}, e = 0; e < d.length; e += 1) this.$Q(d[e], c)
			} else this.$Q(a, b)
		},
		ewa: function(a) {
			for (var b = 0; b < this.Ez.length; b += 1)
				if (this.Ez[b] === a) return;
			this.Ez.push(a)
		},
		On: function(a, b) {
			var c = this.SC(a);
	...
	window._jsload_ = function(a, b, c) {
		var d = g.ub.SC(a);
		d.VK && 0 <= g.a.indexOf(document.body.childNodes, d.VK) && document.body.removeChild(d.VK);
		d.VK = null;
		try {
			if (!c && window.localStorage && b && "" !== b && g.l.Kv) {
				var e = window.localStorage["_AMap_" + a],
					e = e || "{}",
					e = JSON.parse(e);
				e.version !== g.o.Ek || e.script ? window.localStorage.setItem("_AMap_" + a, JSON.stringify({
					version: g.o.Ek,
					script: b
	...
	window._cssload_ = function(a, b, c) {
		try {
			!c && window.localStorage && b && "" !== b && g.l.Kv && window.localStorage.setItem("_AMap_" + a,
				JSON.stringify({
					css: b,
					version: g.o.Ek
				}))
		...
		e.type = "text/css"; - 1 === g.o.Hb.indexOf("webapi.amap.com") && (b = b.replace(/webapi.amap.com/gi, g
			.o.Hb.split("://")[1]));
	...
	(function(a) {
		...
		if (!g.indexedDB && b.Oi) {
			var c = a.indexedDB || a.webkitIndexedDB || a.msIndexedDB || a.mozIndexedDB,
				d = a.IDBKeyRange || a.qIa || a.YFa || a.XFa;
			if (c) {
				var e = g.a,
					f = null;
				a = "amap-jsapi" + (a.EAa ? "-debug" : "");
				var h = g.extend({}, g.va),
					k;
				try {
	...
	(function() {
		...
		function b(a) {
			var b = g.o.Ek + "|" + a.Pi.replace(/\//g, ",") + "|" + (a.Nf ? "w" : "v") + "|",
				c;
			c = a.ja;
			var d = a.Be;
		...
		function n(a) {
			if ("object" ===
				...
				else if (r.kk(a, "Float32Array")) b.push("__Float32Array"), b.push(Array.prototype.slice.call(
					a));
			...
			var s = g.indexedDB,
				...
				w = {
					...
					setItem: function(a, b, c) {
						var d = b;
						c && (d = JSON.stringify(b), 1.5 < d.length / 1024 / 1024 && Object.keys(b.iqa)
							.length && (b.iqa = {}, d = JSON.stringify(b)));
						try {
			...
			g.Oj = {
				...
				get: function(c, d) {
					function f(a) {
						...
						a && B.length && (/\|limg/.test(B[0]) ? b.n6 = a.map(function(a) {
					...
					var k = "FS" === c.type;
					if (!q.Kv || !(k || q.Oi && 0 !== u.data.keys.length)) return d({
						code: 1
					});
					var l = [],
						w = [],
					...
					s.get(B, {
						...
						if (b || c.length !== B.length) b && 3 === b.code ? q.Oi = !1 : e(), G =
							w, w = [], f(null);
						else {
							if (k)
				...
				set: function(a, c) {
					a.mf && a.mf !== u.data.vdataVer && (l(a.mf), e(), c && c({
						code: 2
					}));
				...
				tG: function() {
					...
					f.length ? (f.forEach(function(a) {
						...
						a ? 3 !== a.code ? e() : q.Oi = !1 : (u.data.keys = u.data.keys
							.concat(h), w.setItem(u.key, u.data, !0), c())
					}) : w.setItem(u.key, u.data, !0)), u.rt = b) : (a && w.setItem(u.key, u.data, !
						0), c())
				}
			};
			h()
	...
	g.pe = g.da.extend({
		...
		contains: function(a) {
			var b = this.wc,
				c = this.oc,
				d;
			if (a instanceof g.vp) return this.fV().contains(a);
		...
		yi: function() {
			return new g.U(this.wc.R > this.oc.R ? (this.wc.R + this.oc.R + 360) / 2 % 360 : (this.wc
				.R + this.oc.R) / 2, (this.wc.Q + this.oc.Q) / 2)
		},
		extend: function(a) {
		...
		uR: function(a, b) {
			return this.fV(b).uR(a)
		},
		rR: function(a) {
			return this.Bya(a).yi()
		}
	});
	g.pe.Yb({
		lv: "getSouthWest",
	...
	g.vp = g.da.extend({
		...
		toBounds: function() {
			for (var a = new g.pe(180, 90, -180, -90), b = this.Td.length - 1; 0 <= b; b -= 1) a.extend(
				this.Td[b]);
			return a
		},
		uR: function(a) {
	...
	g.Xf = g.da.extend({
		A: function() {
			if (2 === arguments.length) this.kc = arguments[0], this.Xd = arguments[1];
	...
	g.I = {};
	g.I.SP = function(a) {
		for (var b = [Infinity, Infinity, -Infinity, -Infinity], c = 0, d = a.length; c < d; c += 1) g.I.KI(b,
			a[c]);
		return b
	};
	g.I.c2 = function(a, b, c) {
		var d = Math.min.apply(null, a);
		a = Math.max.apply(null, a);
		var e = Math.min.apply(null, b);
		b = Math.max.apply(null, b);
		return g.I.soa(d, a, e, b, c)
	};
	...
	g.I.transform = function(a, b, c) {
		...
		b(a, a, 2);
		return g.I.c2([a[0], a[2], a[4], a[6]], [a[1], a[3], a[5], a[7]], c)
	};
	g.pe.Ib({
		A: function() {
	...
	g.MF = g.da.extend({
		...
		transform: function(a, b) {
			return this.u1(a.eb(), b)
		},
		u1: function(a, b) {
			b = b || 1;
			a.x = b * (this.gX * a.x + this.wX);
			a.y = b * (this.KX * a.y + this.gY);
			return a
		},
		vza: function(a, b) {
			b = b || 1;
			return new g.H((a.x / b - this.wX) / this.gX, (a.y / b - this.gY) / this.KX)
		}
	});
	g.Bp = g.da.extend({
		A: function(a) {
	...
	g.Bp.vW = {
		...
		Xh: function(a, b) {
			for (var c = 180 / Math.PI, d = this.hM, e = this.iM, f = a.x * c / d, d = e / d, d = Math.sqrt(
	...
	g.$h.bW = g.extend({}, g.$h.rF, {
		code: "EPSG:3395",
		Qf: g.Bp.vW,
		WE: function() {
			var a = g.Bp.vW;
			return new g.MF(0.5 / (Math.PI * a.hM), 0.5, -0.5 / (Math.PI * a.iM), 0.5)
		}()
	});
	g.$h.cW = g.extend({}, g.$h.rF, {
		code: "EPSG:4326",
		Qf: g.Bp.rW,
		WE: new g.MF(1 / 360, 0.5, -1 / 360, 0.25)
	});
	g.$h.$Aa = g.extend({}, g.$h.rF, {
		Qf: g.Bp.rW,
		WE: new g.MF(1, 0, 1, 0)
	});
	g.TJ = {
	...
	z.Sb = g.da.extend({
		...
		setVectorMapForeign: function(a) {
			if (g.l.Yp) {
				...
				g.ub.Gg(b, function() {
					d.s6(function() {
						d.map && (d.map.Gi = !0, d.map.GG && d.map.GG(), d.map.Se && d
							.map.Se instanceof g.Sb.EF && d.map.Se.je && d.map.Se.je
							.S && (d.map.Se.je.S.fI(), d.map.Se.je.S.M6 = c, d.map
								.Se.je.S.reload()), d.set("display"))
					})
				})
			}
		},
		setMapStyle: function(a) {
			...
			a = a || "normal"; - 1 === a.indexOf("amap://styles/") ? g.o.fK[a] ? this.set("styleUrl",
				"amap://styles/" + g.o.fK[a]) : this.set("styleUrl", "") : this.set("styleUrl", a);
			this.aT()
		},
		...
		setLang: function(a) {
			...
			"en" !== a && "zh_cn" !== a && "zh_en" !== a || a === this.get("lang", null, !0) || (this
				.set("lang", a), this.ik && this.ik.B8(this))
		},
		getLang: function() {
		...
		getScreenShot: function(a, b) {
			...
			return this.map && g.l.jl ? this.map.G4(a, b) : ""
		},
		getCity: function(a, b) {
			g.c.add(this, "getCity");
			var c = g.o.fd + "/v3/geocode/regeo?&extensions=&&key=" + g.o.key +
		...
		A: function(a, b) {
			...
			this.C = !0;
			b = b || {};
			b.mapStyle && g.o.fK[b.mapStyle] && (b.mapStyle = "amap://styles/" + g.o.fK[b.mapStyle]);
			...
			b.zooms ? (b.zooms[0] = Math.max(d, b.zooms[0]), !0 === b.expandZoomRange && (c = g.l.ba ? g
				.l.Kc ? 19 : 20 : 20), b.zooms[1] = Math.min(c, b.zooms[1])) : b.zooms = [d, c];
			b.forceZooms && (b.zooms = b.forceZooms);
			b = this.kna(b);
			c = this.getSize(!0);
			b.center && (b.center =
				g.a.Ka(b.center));
			this.nj = this.toa(b.crs || this.w.crs, b.center || this.w.center);
			this.pma(c, b);
			d = b.lang;
			"en" !== d && "zh_cn" !== d && "zh_en" !== d && (b.lang = "zh_cn");
			g.f.qg || (b.rotation = 0, b.pitch = 0, b.rotateEnable = !1);
			b.preloadMode = !1;
			g.l.IS ? !1 !== b.workerMode && (z.Sb.Rt ? (b.workerMode = !1, z.Sb.Rt++) : z.Sb.Rt = 1) : b
				.workerMode = !1;
			b.layers && (d = b.layers, delete b.layers, b.layers = d);
			b.baseRender = b.baseRender || g.l.V1;
			...
			g.l.jl && (b.vectorMapForeign ||
				b.mapStyle || b.nolimg) && f.push("labelcanvas");
			b.editEnable && f.push("edit");
			g.l.jl && (f.push("AMap.IndoorMap"), -1 !== f.indexOf("Map3D") && f.push(
				"AMap.IndoorMap3D"));
				...
				e.s6(function() {
					g.ub.Gg(f, function() {
						if (!e.get("destroy")) {
							var b = new g.Sb(a, e);
							if (g.Ue) {
								var c = (g.Ue[0] || g.Ue).stylemaps["50001:1"]
									.browserStyle[0].split("&");
								b.XF = [c[0], c[4]]
							}
							b.bf("zoom center centerCoords rotation yaw pitch resolution"
								.split(" "), e.view,
								!0);
							...
							b.nj = e.nj;
							e.bf(["zoomSlow", "panTo", "targetLevel", "render"],
								b);
							b.bf(["size", "bounds"], e);
							e.loaded = !0;
							e.r("coreMapCreated");
							...
							"3D" === e.view.type && (e.AmbientLight || (e
								.AmbientLight = new g.Vw.RV([1, 1, 1],
									0.9)), e.DirectionLight || (e
								.DirectionLight = new g.Vw.aW([0, -1,
									1], [1, 1, 1], 0.1)));
							e.C = !1
						}
					})
		...
		s6: function(a) {
			try {
				...
				if (b)
					if (g.RJ = 0, g.QJ = 0, "string" == typeof b && "style_" == b.substr(0, 6)) {
						var c = this,
							d, e = b.slice(6);
						32 == e.length ? (c.ls = !0, g.o.cqa = g.o.UI + "style_local/", d = g.o.fd +
							"/v4/sdk/map/styles?styleid=" +
							e + "&key=" + g.o.key + "&sdkType=abroad_js_json&s=rsv3", d +=
							"&platform=JS&logversion=2.0", d += "&appname=" + g.o.Ao, d +=
							"&csid=" + g.a.kr(), d += "&sdkversion=" + g.o.Xl, g.o.Xa && (d +=
								"&jscode=" + g.o.Xa)) : (c.ls = !1, g.o.cqa = g.o.UI + b + "/", d =
							g.o.Hb + "/styles/foreign/web_v8_" + b + ".json");
						var f = new g.kb.XMLHttpRequest(d, {
							rU: "application/json",
							responseType: "json"
						});
						f.h("complete", function(b) {
							if (b && b.data && !b.data.ODa) {
								...
								}(d = b.style) && d.layers && (g.Qta = d.layers, b.zoomlevel &&
									(g.RJ = b.zoomlevel[0], g.QJ = b.zoomlevel[1]))
					...
					} else this.ls = !1, this.set("vectorMapForeign", !1), a();
				else this.ls = !1, this.set("vectorMapForeign", !1), a()
			} catch (h) {
				this.ls = !1, this.set("vectorMapForeign",
					!1), a()
			}
		},
		Hta: function(a) {
			function b() {
				var a = AMap.anole,
					...
					e = void 0;
				if (a) {
					for (var a = a.replace(/\?/g, ":").replace(/\//g, "&"), e = a.split(""), a = 0, f =
							e.length; a < f; a++) void 0 === b[e[a]] && (b[e[a]] = d++, c.push(e[a]));
					c.reverse();
					d = 0;
			...
			if (g.l.Ve || g.Ue) a();
				...
				if (window.__AMapStyleSource) c = !1;
					...
					d && d.version === g.l.mf && d.script && 100 < d.script.length ? eval(d
						.script) :
						c = !1
				} catch (e) {
					c = !1
				...
				if (c) b(), a();
					...
					f.sDa = "anonymous";
					f.id = "amap_anole_js";
					f.src = window.__AMapStyleSource || g.o.Cc + "://vdata.amap.com/style?v=" + g.o.Xl +
						"&key=" + g.o.key + "&mapstyle=normal";
					c = document;
		...
		pma: function(a, b) {
			if (!(b && b.center && b.zoom)) {
				var c = this.sqa(g.o.Td, a, b.zooms);
		...
		Nxa: function(a, b) {
			...
			for (f in a)
				...
				var f = {},
					h;
				for (h in d) d.hasOwnProperty(h) && (f[h] = "center" === h ? a[h].add(c[h].bb(a[
					h]).Pd(e)) : a[h] + (c[h] - a[h]) * e);
				return f
		...
		voa: function(a) {
			"3D" === this.get("viewMode") && g.l.sp ? (this.set("baseRender", "vw"), this.view = new g
				.sM(this, a)) : this.view = new g.PF(this, a);
			this.q5()
		},
		q5: function() {
		...
		MU: function() {
			if (this.sm) {
				...
				if (!1 === this.get("showIndoorMap") || "normal" !== b && "amap://styles/normal" !== b)
					a = !1;
				for (var b = this.getLayers(), c = this.C = !1, d = 0, e = b.length; d < e; d +=
					1) {
		...
		eQ: function() {
			...
			if (this.view && "3D" !== this.view.type) {
				...
				if (a && !("dv" < a)) {
					...
					b && c && (g.l.Yp && (d || "all" !== b || "normal" !== c &&
						"amap://styles/normal" !==
						c) ? (this.set("baseRender", "v"), this.wT = a) : this.wT && (this.set(
						"baseRender", this.wT), this.wT = null));
					this.q5()
				}
			}
		},
		Rla: function() {
			var a = this;
			!a.sm && a.K && (a.indoorMap = a.sm = new AMap.IndoorMap({
				innerLayer: !0
			}), a.MU(), g.a.Xc(function() {
				a.r("indoor_create", {
					target: a
				});
				a.set("display")
		...
		v$: function() {
			function a() {
				...
				g.a.Ub(b.w.layers, function(b) {
					if (b.HG && b.constructor === z.q.sb) return a = !0, !1
				}, b);
			...
			if (!this.f8) {
				...
				if (d && !c) this.tk(d), this.set("rasterLayer",
					void 0);
					...
					if (this.w.layers) {
						...
						g.a.Ub(this.w.layers, function(a) {
							a instanceof z.q.sb && a.HG && (null === e || a.get("zIndex") > e
								.get("zIndex")) && (e = a)
						});
		...
		kna: function(a) {
			...
			a.layers && 0 !== a.layers.length ?
				this.set("defaultLayer", a.layers[0], !0) : (b = new z.q.sb({
					innerLayer: !0
				}), a.layers = [b], b.IP = !0, this.set("defaultLayer", b, !0));
		...
		uC: function(a) {
			...
			0 <= g.a.indexOf(b, a) || (a instanceof z.B.Un ? (this.get("overlays").push(a),
				this.vy instanceof z.B.Un && (this.vy.C = !0, this.vy.close(), this.vy.C = !1),
				this.vy = a, this.set("contextmenu", a, !0)) : (a instanceof z.B.Ze && (this
				.tm instanceof z.B.Ze && this.Lz(this.tm), this.tm = a), this.get(
				"overlays").push(a)), this.r("overlays"))
		},
		tk: function(a) {
			var b = this.get("layers"),
				c = g.a.indexOf(b, a);
			if (-1 !== c) {
				if (a.zB)
					...
					} else a.$A && a.$A.Vka(a), b = g.a.Ho(b, c);
				this.set("layers", b);
				if (a.zB)
					for (a = a.getLayers(), b = -1, c = a.length; ++b < c;) d = a[b], d instanceof
				z.q.Zb || !d.setMap || d.setMap()
			}
		},
		getZooms: function() {
		...
		getTileCoordByLngLat: function(a, b, c) {
			...
			this.C = !1;
			a = this.lc(a, c);
			c = new g.rr(c, Math.floor(a.x / b), Math.floor(a.y / b));
			c.cD = a.x % b;
			c.dD = a.y % b;
			return c
		},
		setZoom: function(a, b) {
			...
			a > c[1] && (a = c[1]);
			a < c[0] && (a = c[0]);
			this.get("zoomEnable") && (b || !this.loaded ? (this.set("zoom", a), this.r("zoomstart"),
				this.r("zoomchange"), this.r("zoomend")) : this.set("zoomSlow", a))
		},
		getZoom: function(a) {
			g.c.add(this, "getZoom");
			return a ? this.get("zoom", null, !0) : this.iD(this.get("targetLevel") || this.get("zoom",
				null, !0))
		},
		getCenter: function() {
		...
		setCenter: function(a, b) {
			...
			a = g.a.Ka(a);
			b || !this.loaded ? (this.r("movestart"), this.set("center",
				a), this.r("mapmove"), this.map ? this.map.r("moveend") : this.r("moveend")) : (this
				.C = !0, this.panTo(a), this.C = !1)
		},
		getCoordsBound: function() {
			return this.view.lm()
		},
		getCoordsBoundByZoom: function(a) {
			return this.view.pqa(a)
		},
		setRotation: function() {
			var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 0;
			g.c.add(this, "setRotation");
			!g.l.Ve && this.get("rotateEnable") && this.set("rotation", a)
		},
		...
		getResolution: function(a, b) {
			...
			return this.nj.oq(b || this.get("zoom")) * Math.cos(c * Math.PI / 180)
		},
		getScale: function(a) {
		...
		getDefaultCursor: function() {
			...
			return this.get("defaultCursor", null, !0) || "url(" + g.o.Hb +
		...
		setZoomAndCenter: function(a, b, c) {
			...
			a < d[0] && (a = d[0]);
			this.C = !0;
			this.loaded ? this.set("zoomAndCenter", [a, b, c]) : (this.setZoom(a, !0), this.setCenter(b,
				!0));
			this.C = !1
		},
		clearMap: function() {
		...
		getAllOverlays: function(a, b) {
			...
			if (a) {
				for (var d = "amap." + a.toLowerCase(), e = [], f = 0; f < c.length; f += 1) d !== c[f]
					.CLASS_NAME.toLowerCase() || !b && (c[f].Da || c[f].isOfficial) || e.push(c[f]);
				return e
			}
			if (!b) {
				e = [];
			...
			e = [];
			if (d)
				for (var f = 0, h = d.length; f < h; f += 1) d[f] instanceof z.q.OL && e.push(d[f]), d[
					f].lb && (e = e.concat(d[f].lb));
			return c.concat(e)
		},
		...
		panBy: function(a, b, c) {
			...
			b = this.loaded && this.map && this.map.Hd ? this.map.Hd.G9 : this.get("centerCoords");
		...
		setFitView: function(a, b, c, d) {
			...
			if (a = this.s4(a)) {
				if (c = this.dJ(a, 0, new g.H(40, 40), c, d)) b = b || !this.getBounds().contains(a
					.yi()) || g.l.ba &&
					1 < Math.abs(c[0] + this.get("zoom", null, !0)), this.setZoomAndCenter(c[0], c[1],
						b);
				this.C = !1;
				return a
			}
		...
		dJ: function(a, b, c, d, e) {
			...
			var m = a.rR(this);
			a = a.uR(this);
			this.yC || (this.yC = "3D" === l ? new g.sM : new g.PF);
			this.yC.kf({
				size: k,
				zoom: 3,
				rotation: f,
		...
		getLayers: function() {
			...
			if (this.C) {
				...
				for (b = a.length; - 1 < --b;) a[b].$A && a.splice(b, 1);
			return a
		},
		...
		setMask: function(a) {
			...
			this.set("mask", a);
			this.map && (this.map.WJ = !0, this.map.set("display"))
		},
		...
		getCameraState: function() {
			...
			if (this.view && "3D" == this.view.type) return this.view.T3()
		},
		endDraw: function() {
			this.set("draw", null)
		},
		...
		gJ: function(a) {
			...
			if (this.C) {
				for (var c = [], d = -1, e = b.length; ++d < e;) {
					var f = b[d];
					if (f.zB)
						for (var f = f.AEa(), h = -1, k = f.length; ++h < k;) {
		...
		queryObjectIndexFromFboByContainerPos: function(a, b) {
			...
			var c = this.diffFilterLayers(b),
				d = this.gJ(b),
				e = this.getSize();
			if (c) this.$G = this.view.Me.eb(), this.ZG = this.view.dc.eb();
			else if (this.$G && this.ZG) {
				if (c = this.ZG.$u(this.view.dc), c = !(this.$G.$u(this.view.Me) && c)) this.$G = this
					.view.Me.eb(), this.ZG = this.view.dc.eb()
			} else this.$G = this.view.Me.eb(), this.ZG = this.view.dc.eb();
			if (c) this.map.Qq(d);
			else {
				for (var f = 0; f < d.length; f += 1) {
					var h = d[f];
					if (h instanceof z.q.Pm && h.Qra()) {
						c = !0;
						break
					}
				}
	...
	z.Sb.Yb({
		NJ: "lngLatToGeodeticCoord",
		mqa: "geodeticCoordToLngLat",
		dJ: "getFitZoomAndCenterByBounds",
		e4: "getFitZoomAndCenterByOverlays",
	...
	z.Sb.Ib({
		isHotspotChanged: function() {
			if ("undefined" !== typeof this.wD && (this.Kna(), this.get("isHotspot"))) {
				var a = this.get("layers", null, !0);
				a && a.length && !this.wD && this.$J && this.Zua()
			}
		},
		Zua: function() {
			if (this.ik) this.e5();
		...
		e5: function() {
			...
			this.ik.setMap(this);
			this.ik.C = !1;
			a.h("mouseover", this.o7, this);
			a.h("click", this.m7, this);
			a.h("mouseout", this.n7, this)
		},
		Ura: function() {
			var a = this.ik;
			a.G("mouseover", this.o7, this);
			a.G("click", this.m7, this);
			a.G("mouseout", this.n7, this);
			this.ik.C = !0;
			this.ik.setMap(null);
			this.ik.C = !1;
			this.ik = null
	...
	z.event = {
		...
		addListener: function(a, b, c, d) {
			g.a.Qh(a.addListener) ? a.addListener(b, c, d) : (a.we || (a.we = g.va.we), g.va.h.call(a, b, c,
				d));
		...
		removeListener: function(a) {
			a instanceof
			g.uF && (g.a.Qh(a.Bi.removeListener) ? a.Bi.removeListener(a) : 0 === a.type ? g.F.G(a.Bi, a.XQ,
				a.eS, a.cf) : 1 === a.type && (a.Bi.we || (a.Bi.we = g.va.we), g.va.G.call(a.Bi, a
				.XQ, a.eS, a.cf)))
		},
		O: function(a, b) {
	...
	var qc = {
		...
		rc;
	for (rc in qc) qc.hasOwnProperty(rc) && (z.event[qc[rc]] = z.event[rc]);
	g.event = z.event;
	z.q.Zb = g.da.extend({
		ka: [g.va, g.$e],
		A: function(a) {
		...
		setMap: function(a) {
			g.c.add(this, "setMap");
			var b = this.get("map");
			if (a) b && a !== b && b.tk(this), this.set("map", a);
			else if (b && (b.tk(this), this.set("map", null, !0), this.ri = !1, this.hg && this.hg(),
	...
	z.q.sb = z.q.Zb.extend({
		...
		A: function(a) {
			...
			this.rna(a);
			var b = a.zooms;
			b && b[1] >= this.pl[0] ? (b[0] < this.pl[0] && (b[0] = this.pl[0]), b[1] > this.pl[1] && (
				b[1] = this.pl[1])) : a.zooms = [this.pl[0], this.pl[1]];
		...
		A4: function(a) {
			var b = g.o.UJ;
			g.l.ja && this.get("detectRetina") && (b = g.o.UJ.replace("scl=1", "scl=2"));
		...
		cg: function(a) {
			...
			if (this.Wv) return new g.q.sb(this, a, this.Ar(this.A4(!0)), this.w.maxDataZoom, !0);
			if (b)
				if (this.Hq = !0, g.q.fi) {
					if ("dv" === c.get("baseRender") && !this.get("watermark")) {
						var b = c.get("showBuildingBlock"),
							d = new g.q.sb(this, a, this.Ar(this.A4(!b)), void 0, !0);
						b && (d.Ij = new g.q.qd(new z.q.sb({
							zooms: [16, 20],
							innerLayer: !0
						}), a, ["building"]), d.Ij.type = "\u697c\u5757\u56fe\u5c42", d.Ij.bf([
							"visible",
							"opacity", "zIndex"
						], d, !0), d.Ij.CC(c.get("mapStyle") || "normal"));
						d.type = "\u6805\u683c\u5e95\u56fe";
						return d
					}
					if ("v" <= c.get("baseRender") || this.get("watermark")) return "3D" == a.D.view
						.type ? (c = new g.q.qd(this, a, ["region", "road"]), c.type =
							"\u77e2\u91cf\u5e95\u56fe", b = new z.q.sb({
								zooms: [17, 20],
								zIndex: 50,
								innerLayer: !0
							}), c.Ij = new g.q.qd(b, a, ["building"]), c.Ij.gf = 17, c.Ij.type =
							"\u697c\u5757\u56fe\u5c42", c.Ij.az = 1, c.Ij.bf(["visible", "merge",
								"sort", "opacity"
							], c, !0), b.X("rejectMapMask", this, !0)) : (c = new g.q.qd(this,
								a, ["region", "building", "road"]), c.type =
							"\u77e2\u91cf\u5e95\u56fe"), a.zma = c
				} else return ["vectorlayer", "overlay"];
			else return this.Hq = !1, new g.q.sb(this, a, null, this.w.maxDataZoom)
		},
		getTileUrlChanged: function() {
			var a = this.get("getTileUrl");
			if (a === g.o.QD || a === g.o.VE || a === g.o.QK) this.$J = !0;
			"string" === typeof a && (a = this.Ar(a));
			this.set("tileFun", a)
		},
		rna: function(a) {
			this.pl || (this.pl = [this.w.zooms[0], this.w.zooms[1]]);
			var b;
		...
		setTileUrl: function(a) {
			...
			this.x2() ? (this.set("getTileUrl", a), this.ct()) :
	...
	z.q.sb.DW = z.q.sb.extend({
		...
		cg: function(a) {
			if (this.get("map").Ci) {
				this.Hq = !0;
				var b = g.o.RK;
				g.l.ja && this.get("detectRetina") && (b = g.o.RK.replace("scl=1", "scl=2"));
				a = new g.q.sb(this, a, this.Ar(b), this.w.maxDataZoom)
			} else this.Hq = !1, a = new g.q.sb(this,
				a);
			return a
		}
	});
	z.q.sb.OW = z.q.sb.extend({
		w: {
			getTileUrl: function(a, b, c) {
				return g.o.Cc + "://tm.amap.com/trafficengine/mapabc/traffictile?v=1.0&t=1&zoom=" + (
					17 - c) + "&x=" + a + "&y=" + b
			},
			zooms: [6, 20],
			zIndex: 4,
		...
		stopRefresh: function() {
			g.c.add(this,
				"stopRefresh");
			this.EK && (clearInterval(this.EK), this.EK = null)
		},
		startRefresh: function() {
			g.c.add(this, "startRefresh");
			if (this.get("autoRefresh") && !this.EK) {
				var a = this;
				this.EK = setInterval(function() {
					a.C = !0;
					a.reload();
					a.C = !1;
					a.r("refresh")
		...
		cg: function(a) {
			...
			return "d" !== b.get("baseRender") ? g.q.cx ? a = new g.q.cx(this, a) : ["vt"] : a = new g.q
				.sb(this, a, null, this.w.maxDataZoom)
		}
	});
	z.q.sb.AA = z.q.sb.extend({
		w: {
			zooms: [3, 20],
			zIndex: 12,
			detectRetina: !1,
					...
					if (l) h();
						...
						m.src = function(a, c, d) {
							...
							return g.o.Cc + "://grid.amap.com/grid/" + d + "/" +
								a + "/" + c + "?src=jsapi&key=" + g.o.key +
								"&lang=" + e + "&dpiType=" + (g.l.Kc ? "wprd" :
									"webrd")
						}(a, d, e)
					}
				})
	...
	z.q.Y$ = z.q.Zb.extend({
		...
		cg: function(a) {
			if (g.l.Yp) return a = new g.q.Gba(this, a), a.az = this.get("heightFactor") || 1, a
		},
		setStyle: function(a) {
	...
	z.q.Taa = z.q.Zb.extend({
		...
		A: function(a, b) {
			...
			g.c.ya(this, b);
			g.l.jl && (this.Aj = !0, b.size && (b.size = g.a.Mq(b.size)), this.C = !0, this.setData(a),
				g.a.vb(this, b), b.style ? (this.kf(this.w, !0), this.setStyle(b.style)) : this
		...
		setStyle: function(a) {
			...
			if (a instanceof Array) {
				for (var b = 0; b < a.length; b += 1) a[b].rotation_ = Math.PI * (a[b].rotation || 0) /
					180, a[b].size = g.a.Mq(a[b].size), a.Bf = Math.max(a.Bf || 0, a[b].size.width + a[
						b].anchor.x), a.jg = Math.max(a.Bf || 0, a[b].size.height + a[b].anchor.y);
				this.Em = a
			} else a.size && (a.size = g.a.Mq(a.size)), a.rotation_ = Math.PI * (a.rotation || 0) / 180,
				this.kf(a, !0), this.Em = {
				...
				this.Em.Bf = this.Em.size.width + this.Em.anchor.x, this.Em.jg = this.Em.size.height +
				this.Em.anchor.y;
			this.r("style")
		},
		setData: function(a) {
		...
		setMap: function(a) {
			g.c.add(this, "setMap");
			g.l.jl && (a ? (this.get("map") && this.get("map").tk(this), this.set("map", a)) : this.get(
				"map") && (this.get("map").tk(this), this.set("map", null, !0), this.ri = !1,
				this.hg && this.hg()))
		},
		cg: function(a) {
	...
	z.q.daa = z.q.Zb.extend({
		...
		opacityChanged: function() {
			for (var a = this.get("opacity", null, !0), b = -1, c = this.Xm.length; ++b < c;) this.Xm[b]
				.setOpacity(a)
		},
		addLayer: function(a) {
			if (!this.has(a)) {
	...
	z.q.sr = z.q.Zb.extend({
						...
						var d = c.w,
							e = {
								data: {
									...
									name: d.title || "",
									position: this.pfa(d.position) || void 0,
									rank: d.rank || void 0
								},
								opts: {
				...
				if (this.Yf) {
					for (a = 0; a < b.length; a++) {
						var c = this.wn(this.Yf,
							b[a]); - 1 !== c && (this.Yf.splice(c, 1), this.lb.splice(c, 1))
					}
					this.Jo()
				}
			}
		...
		on: function(a) {
			g.c.add(this, "on");
			this.g ? (this.Dh(arguments), this.g.Z1(a)) : this.Qu.push(arguments)
		},
		off: function(a) {
			g.c.add(this, "off");
			this.g && this.g.q$(a)
		...
		KU: function(a, b) {
			...
			a && (b ? (c && c._LabelMarkerId !== a._LabelMarkerId &&
				c.setTop(!1), this.qP = a) : this.qP = null)
		},
		yR: function(a) {
			if (this.g) return this.g.yR(a)
		},
		wn: function(a, b) {
		...
		yG: function() {
			var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : [];
			return this.Jf(a.width) || this.Jf(a.height) ? this.SZ(a) ? a.split(",") : this.Cga(a) ? [a,
				a
			] : a : [a.width, a.height]
		},
		pfa: function() {
			var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : [];
			return this.Jf(a.R) ||
				this.Jf(a.Q) ? this.SZ(a) ? a.split(",") : a : [a.R, a.Q]
		},
		uha: function(a) {
	...
	z.q.OL = z.q.DA.extend({
		...
		setMap: function(a) {
			g.c.add(this,
				"setMap");
			a ? (this.get("map") && (this.get("map").tk(this), this.H2 && z.event.removeListener(this
				.H2), this.Y2 && z.event.removeListener(this.Y2)), this.set("map", a)) : this.get(
				"map") && (this.get("map").tk(this), this.De.map = null)
		},
		mapChanged: function() {
			this.get("map") && (this.get("map").RH(this), this.get("clickable") && (this.H2 = z.event
				.addListener(this.get("map"), "click", this.Pua, this), this.Y2 = z.event
				.addListener(this.get("map"), "dblclick", this.Qua, this)))
		}
	});
	z.B.Fh = g.da.extend({
		ka: [g.va, g.$e, {
		...
		setMap: function(a) {
			...
			a !== this.get("map", null, !0) && (a ? (this.get("map", null, !0) && this.get("map", null,
				!0).Lz(this), this.set("map", a)) : this.get("map", null, !0) && (this.get(
				"map", null, !0).Lz(this), this.set("map", null, !0)))
		},
		getMap: function() {
			g.c.add(this,
				"getMap");
	...
	z.B.fM = z.B.hd.extend({
		...
		A: function(a) {
			z.B.fM.cd.A.apply(this, arguments)
		},
	...
	z.B.wb = z.B.Fh.extend({
		...
		mapChanged: function() {
			this.yl("zoom");
			var a = this.get("map", null, !0);
			a && (this.get("position", null, !0) || this.set("position", a.get("center")), a.uC(this),
				this.X("zoom", a))
		},
		getZooms: function() {
	...
	z.B.Kaa = z.B.Fh.extend({
		...
		setPosition: function(a) {
			...
			if (b) {
				var c = b.Yf,
					d = this.wn(c, this); - 1 !== d && (c[d].data.position = a, b.Jo())
			}
		},
		getZooms: function() {
			g.c.add(this, "getZooms");
		...
		setZooms: function(a) {
			...
			if (b) {
				var c = b.Yf || [],
					d = this.wn(c, this); - 1 !== d && (c[d].opts.zooms = a, b.Jo())
			}
		},
		getOpacity: function() {
			g.c.add(this, "getOpacity");
		...
		setOpacity: function(a) {
			...
			if (b) {
				var c = b.Yf,
					d = this.wn(c, this); - 1 !== d && (c[d].opts.opacity = a, b.Jo())
			}
		},
		getzIndex: function() {
			g.c.add(this, "getzIndex");
		...
		setText: function(a) {
			...
			if (b) {
				var b = b.Yf,
					c = this.wn(b, this); - 1 !== c && (b[c].data.txt = void 0 == a.content ? b[c].data
		...
		setTop: function() {
			...
			g.c.add(this, "setTop");
			this.g && this.g.KU(this, a);
			a ? (this.Aca = this.w.zIndex, this.setzIndex(this.Vaa)) : this.setzIndex(this.Aca || this.w
				.zIndex)
		},
		getVisible: function() {
			g.c.add(this, "getVisible");
			var a = this.w.visible;
			this.g && a && (a = !this.g.yR(this._LabelMarkerId));
			return a
		},
		getExtData: function() {
			g.c.add(this, "getExtData");
	...
	z.B.Un = z.B.Fh.extend({
		...
		open: function(a, b) {
			...
			b = g.a.Ka(b);
			this.set("position", b);
			this.map ? this.map && this.map !== a && (this.map.Lz(this), this.map = a, this.setMap(a)) :
	...
	z.B.Ze = z.B.Fh.extend({
		...
		A: function(a) {
			...
			a.height && this.set("altitude", this.eR(a.height), !0)
		},
		open: function(a, b, c) {
			g.c.add(this, "open");
			b = g.a.Ka(b);
			if (a && !this.jL && (b =
				...
				c = this.eR(c) || this.get("altitude");
				var d = this.get("map", null, !0);
				d && d === a ? (this.set("altitude", c, !0), this.set("position", b)) : (this.map = a, a
					.tm && a.tm.close(), this.set("position", b, !0), this.set("altitude", c, !0),
	...
	z.B.uA = z.B.$b.extend({
		...
		getInterpolateLngLats: function() {
			...
			var a = this.get("map");
			return g.Nw.Uqa(this.get("path"), a && a.nj || g.$h.KL, Math.pow(2, 2), this.w)
		},
				...
				if (e instanceof g.U) {
					...
					if (e.controlPoints)
						for (var h = 0, k = e.controlPoints.length; h < k; h++) f.push(e.controlPoints[
							h].CR()), f.push(e.controlPoints[h].zR());
					f.push(e.CR());
					f.push(e.zR());
					b.push(f)
				} else b.push(e)
		...
		Ka: function(a) {
			...
			if (g.a.isArray(a) && "object" === b) {
				for (b = 0; b < a.length; b += 1) a[b] = this.Bja(a[b]);
				return a
			}
			return [this.sGa(a)]
		},
	...
	z.B.Ec = z.B.fM.extend({
		...
		getArea: function() {
			...
			for (var a = this.get("path", null, !0), a = this.dK(a), b = 0, c = 0, d = a.length; c <
				d; c += 1)
				for (var e = a[c], b = b + this.y4(e[0]), f = 1; f < e.length; f += 1) b -= this.y4(e[
					f]);
			return Number(b.toFixed(2))
		},
		toString: function() {
			g.c.add(this, "toString");
			for (var a = this.get("path"), a = this.dK(a), b = [], c = 0, d = a.length; c < d; c += 1) {
		...
		getBounds: function() {
			var a = this.get("path");
			if (a && a.length) {
				for (var a = this.dK(a), b = new g.pe(180, 90, -180, -90), c = 0, d = a.length; c <
					d; c += 1)
		...
		contains: function(a) {
			...
			for (var c = 0, d = b.length; c < d; c += 1) {
				for (var e = b[c], f = !1, h = 0, k = e.length; h < k && (f = this.fna(e[h]), g.yd.vq(
						f) || f.reverse(), f = g.yd.Ud(a, f, 0 === h ? !0 : !1), 0 < h && (f = !f), f
						); h += 1);
				if (f) return !0
			}
			return !1
	...
	z.B.hh = z.B.hd.extend({
		...
		A: function(a) {
			...
			a.center && (a.center = g.a.Ka(a.center));
			a.zIndex = "number" === typeof a.zIndex ? a.zIndex : 10;
			g.a.kk(a.radius, "string") && (a.radius = parseFloat(a.radius), isNaN(a.radius) && delete a
				.radius);
			g.a.vb(this, a);
		...
		setCenter: function(a, b) {
			...
			(a = g.a.Ka(a)) && a instanceof g.U && (this.B && this.B.get("deltaPos") && this.B.set(
					"deltaPos", [0, 0], !0), this.set("center", a), this.r("change", {
					type: "change",
					target: this
				}), this.ah || (this.ah = !0, this.get("map") && this.get("map").r("overlays")),
				b || this.r("setCenter"))
		},
		getCenter: function() {
			g.c.add(this, "getCenter");
		...
		reset: function() {
			var a = this.get("center", null, !0);
			this.B && this.B.get("deltaPos") && (a = this.B.Ut([a], this.B.get("deltaPos"))[0], this.B
				.set("deltaPos", [0, 0], !0));
			this.set("center", a)
		},
	...
	z.B.XV = z.B.hh.extend({
		A: function(a) {
			this.CLASS_NAME = "AMap.CircleMarker";
			g.c.ya(this, a);
			a = a || {};
			a.unit = "px";
			void 0 === a.radius ? a.radius = 20 : g.a.kk(a.radius, "string") && (a.radius = parseFloat(a
				.radius), isNaN(a.radius) && (a.radius = 20));
			z.B.XV.cd.A.apply(this, arguments)
		},
		getBounds: function() {
			this.C = !0;
	...
	var sc = g.da.extend({
		A: function(a) {
			var b = Array(3),
				c;
			c = a instanceof Array ? a : a instanceof g.Gl || a instanceof g.Pa ? a.elements :
			arguments;
			b[0] = c[0] || 0;
			b[1] = c[1] || 0;
			b[2] = c[2] || 0;
	...
	function yc(a, b, c, d, e, f) {
		this.kE = [void 0 !== a ? a : new g.Yw, void 0 !== b ? b : new g.Yw, void 0 !== c ? c : new g.Yw, void 0 !==
			d ? d : new g.Yw, void 0 !== e ? e : new g.Yw, void 0 !== f ? f : new g.Yw
		]
	}
	g.gW = yc;
	yc.prototype = {
	...
	(function(a) {
		...
		b.prototype.jva = function(a, d, e, f, h, k) {
			return this.concat((new b).HU(a, d, e, f, h, k))
		};
		b.prototype.Axa = function(a, b, e, f, h, k) {
			var l, m, n, p;
		...
		b.prototype.oR = function(a, d, e, f, h, k) {
			return this.concat((new b).Axa(a, d, e, f, h, k))
		};
		b.prototype.b9 = function(a, b, e, f) {
			var h, k;
		...
		b.prototype.perspective = function(a, d, e, f) {
			return this.concat((new b).b9(a, d, e, f))
		};
	...
	z.B.Gt = z.B.Ec.extend({
		...
		A: function() {
			...
			this.on("movepoly", function(b) {
				var c =
					a.get("map");
				b = c.Qd(c.Cb(a.get("center")).add(b.sK));
		...
		Wr: function() {
			...
			if (c && d)
				for (var c = g.a.Ka(c), e = a.radius || this.get("radius"), f = d.Cb(c), a = f.x, f = f
		...
		setCenter: function(a, b) {
			g.c.add(this, "setCenter");
			(a = g.a.Ka(a)) && a instanceof g.U && (this.B && this.B.get("deltaPos") && this.B.set(
					"deltaPos", [0, 0], !0), this.set("center", a), this.set("path", this.Wr()),
				this.ah || (this.ah = !0, this.get("map") && this.get("map").r("overlays")),
				b || (this.r("setCenter"), this.r("change", {
					type: "change",
					target: this
				})))
		},
		setRadius: function(a) {
			...
			g.c.add(this, "setRadius");
			a && 2 === a.length && (this.set("radius", a), this.set("path", this.Wr()), b || (this.r(
				"change", {
					type: "change",
					target: this
				}), this.r("setPath")))
	...
	z.B.Nt = z.B.Ec.extend({
		...
		A: function() {
			...
			this.on("movepoly", function(b) {
				var c = a.get("map"),
					f = a.get("bounds"),
					h = c.Qd(c.Cb(f.wc).add(b.sK));
				b = c.Qd(c.Cb(f.oc).add(b.sK));
		...
		Wr: function() {
			...
			if (b) {
				...
				var c = b.getSouthWest(),
					d = b.getNorthEast();
				b.C = !1;
				g.a.Ub([new g.U(c.R, c.Q, !0), new g.U(d.R, c.Q, !0), new g.U(d.R, d.Q, !0), new g.U(c
					.R, d.Q, !0)], function(b) {
					return a.push(b)
				})
			}
		...
		setBounds: function(a) {
			var b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : !1;
			g.c.add(this, "setBounds");
			a && a instanceof g.pe && (this.set("bounds", a), this.set("path", this.Wr()), this.ah || (
					this.ah = !0, this.get("map") && this.get("map").r("overlays")),
				b || (this.r("change", {
					type: "change",
					target: this
				}), this.r("setBounds")))
	...
	z.B.MW = z.B.wb.extend({
		...
		A: function(a) {
			...
			g.c.ya(this, a);
			z.B.MW.cd.A.apply(this, arguments);
			this.nga();
			this.C = !0;
		...
		setText: function(a) {
			g.c.add(this,
				"setText");
			a || 0 === a || (a = "");
			g.f.Fya(this.lC, "amap-overlay-text-empty", !a);
			g.c.add(this, "setText");
			this.set("text", a);
			this.lC.innerHTML = a;
			this.j8()
	...
	g.jW = {
		...
		remove: function(a) {
			var b = this,
				...
				d = this.ix;
			if (d)
				if (g.a.isArray(a)) g.a.Ub(a, function(a) {
					b.remove(a,
						c)
				});
				else {
	...
	(function(a, b) {
		...
		a.B.hW = a.B.Xn.extend({
			A: function(c) {
				this.CLASS_NAME = "AMap.GeoJSON";
				b.c.ya(this, c);
				a.B.hW.cd.A.call(this, []);
				this.C = !0;
				this.w = b.extend({
			...
			toGeoJSON: function() {
				...
				for (var a = this.ZI(), c = [], d = 0, e = a.length; d < e; d++) a[d].C = !0, c[d] =
			...
			$ca: function(c) {
				for (var d = "Feature" === c.type ? c.geometry : c, d = d ? d.coordinates : null,
						e = [], f = 0, n = d.length; f < n; f++) e.push(this.FX(b.extend({}, c, {
					type: "Feature",
					properties: {
						_isAmap: !0,
						_pointIndex: f,
			...
			Zca: function(c) {
				for (var d = "Feature" === c.type ? c.geometry : c, d = d ? d.coordinates : null,
						e = [], f = 0, n = d.length; f < n; f++) e.push(this.EX(b.extend({}, c, {
					type: "Feature",
					properties: {
						_isAmap: !0,
						_lineStringIndex: f,
			...
			ada: function(c) {
				for (var d = "Feature" === c.type ? c.geometry : c, d = d ? d.coordinates : null,
						e = [], f = 0, n = d.length; f < n; f++) e.push(this.GX(b.extend({}, c, {
					type: "Feature",
					properties: {
						_isAmap: !0,
						_polygonIndex: f,
			...
			Tca: function(c) {
				for (var d = ("Feature" === c.type ? c.geometry : c).geometries, e = [], f = 0, n =
						d.length; f < n; f++) e.push(this.ON(b.extend({}, c, {
					type: "Feature",
					properties: {
						_isAmap: !0,
						_geometryIndex: f,
	...
	z.q.TL = z.q.Zb.extend({
		ka: [g.jW],
		A: function(a) {
			var b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {};
			this.CLASS_NAME = "AMap.LayerGroup";
			g.c.ya(this, b);
			z.q.TL.cd.A.call(this, b);
			this.map = null;
			this.add(a)
		},
		vc: function(a) {
	...
	g.yd = {
		os: function(a, b) {
			for (var c = Infinity, d = 0, e = 1, f = b.length; e < f; d = e, e += 1) c = Math.min(c, g.yd
				.Yxa(a, [b[d], b[e]]));
			return Math.sqrt(c)
		},
		Yxa: function(a, b) {
			return this.cL(a, this.I2(a, b))
		},
		cL: function(a, b) {
			var c = a[0] - b[0],
				d = a[1] - b[1];
	...
	(function(a) {
		function b(b, c) {
			...
			return {
				...
				ringArea: function(b) {
					...
					var c = a.Nm.RQ * a.Nm.Ru,
						d = 0,
						e = b.length;
					if (3 > e) return 0;
					for (var f = 0; f < e - 1; f += 1) var h = b[f],
						k = b[f + 1],
						u = h.R * c * Math.cos(h.Q * a.Nm.Ru),
						h = h.Q * c,
						v = k.R * c * Math.cos(k.Q * a.Nm.Ru),
						d = d + (u * k.Q * c - v * h);
					f = b[f];
					b = b[0];
		...
		a.extend(e.prototype, {
			...
			closestOnSegment: function(b, c, d) {
				b = a.yd.I2(this.project(b), this.Ix([c, d]));
		...
		a.tF = function() {
			...
			function c(a, b) {
				...
				var c = a,
					d;
				do
					if (d = !1, c.w9 || !m(c, c.next) && 0 !== l(c.Ia, c, c.next)) c = c.next;
					else {
						s(c);
						c = b = c.Ia;
						if (c === c.next) break;
				...
				if (a) {
					if (!C && u) {
						var D = a,
							A = D;
						do null === A.z &&
							(A.z = h(A.x, A.y, f, r, u)), A.kp = A.Ia, A = A.ol = A.next; while (A !== D);
						A.kp.ol = null;
						A.kp = null;
						var D = A,
							B, G, H, I, P, L, M = 1;
						do {
							...
							for (I = 0; A;) {
								I++;
								G = A;
								for (B = P = 0; B < M && (P++, G = G.ol, G); B++);
								for (L = M; 0 < P || 0 < L && G;) 0 !== P && (0 === L || !G || A.z <= G.z) ?
									(B = A, A = A.ol, P--) : (B = G, G = G.ol, L--), H ? H.ol = B : D = B, B
									.kp = H, H = B;
								A = G
							}
							H.ol = null;
					...
					for (D = a; a.Ia !== a.next;) {
						...
						if (u) a: if (H = a.Ia, I = a.next, 0 <= l(H, a, I)) H = !1;
							...
							e), b.push(a.xe / e), b.push(G.xe / e), s(a), D = a = G.next;
						else if (a = G, a === D) {
							if (C)
								if (1 === C) {
									C = b;
									...
									do G = A.Ia, H = A.next.next, !m(G, H) && n(G, A, A.next, H) && p(G,
										H) && p(H, G) && (C.push(G.xe / D), C.push(A.xe / D), C.push(H.xe /
									...
									if (2 === C) a: {
										C = a;do {
											for (D = C.next.next; D !== C.Ia;) {
												if (A = C.xe !== D.xe)
													if (A = void 0, A = C.next.xe !== D.xe)
														if (A = void 0, A = C.Ia.xe !== D.xe) {
															A = A = void 0;
															b: {
																A = C;do {
																	if (A.xe !== C.xe && A.next
			...
			function q(a, b) {
				var c = new u(a.xe, a.x, a.y),
					d = new u(b.xe, b.x, b.y),
					e = a.next,
					f = b.Ia;
				a.next = b;
				b.Ia = a;
	...
	g.kb.kM = g.da.extend({
		...
		A: function(a, b) {
			...
			g.a.vb(this, b);
			this.url = a;
			this.send(a, b.Gd, b.Q2, b.rU, b.responseType)
		},
		send: function(a) {
	...
	g.kb.Ab = g.kb.kM.extend({
		lna: function() {
			if (g.a.R8) return g.a.eL.push(this), !0
		},
		Zwa: function() {
			this.r("error", {
				info: "TIME_OUT_A"
		...
		send: function(a, b, c, d) {
			...
			if (!this.w.jy || !this.lna()) {
				a = encodeURI(a);
				var f = this.w.fun;
				if (!f || window[f]) f = g.a.h4("jsonp_", 6) + "_";
				...
				window[f] = function(a) {
					...
					else if (3E4 === a.errcode && a.data) g.a.R8 = !0, g.ub.load(
						"AMap.AntiCrabFrame",
						function() {
							g.a.jy || (g.a.jy = new g.T$);
							g.a.eL.push(k);
				...
				g.kb.Ab.kea = document.getElementsByTagName("body")[0] || document.getElementsByTagName(
					"head")[0];
				g.kb.Ab.kea.appendChild(h)
			}
		}
	});
	g.kb.XMLHttpRequest = g.kb.kM.extend({
		send: function(a, b, c, d, e) {
			var f = this;
			if ((g.l.Ve || g.l.l5) && window.XDomainRequest) {
				var h = this.M$ = new XDomainRequest;
				...
				k.onreadystatechange = function() {
					...
					}) : 404 === k.status && (k.abort(), f.r("error", {
						url: a,
						data: "404"
					}))
				};
	...
	for (var $ = {
			...
			.split(" "), Jc = 0; Jc < Ic.length; Jc += 1) $.event[Ic[Jc]] = function() {
		var a = g.event[Ic[Jc]],
			b = Ic[Jc];
		return function() {
			g.c.ya($.event);
	...
	for (var Kc =
			...
			.split(" "), Jc =
			0; Jc < Kc.length; Jc += 1) $.GeometryUtil[Kc[Jc]] = function() {
		var a = g.Ht[Kc[Jc]],
			b = Kc[Jc];
		return function() {
			g.c.ya($.GeometryUtil);
	...
	for (Jc = 0; Jc < Kc.length; Jc += 1) $.PlaneGeometryUtil[Kc[Jc]] = function() {
		var a = g.ei[Kc[Jc]],
			b = Kc[Jc];
		return function() {
	...
	$.TileLayer.Satellite = z.q.sb.GW;
	$.TileLayer.RoadNet = z.q.sb.DW;
	$.TileLayer.google = z.q.sb.NL;
	$.TileLayer.Flexible = z.q.sb.AA;
	$.TileLayer.WMS = z.q.sb.Jba;
	$.TileLayer.WMTS = z.q.sb.Kba;
	$.TileLayer.Traffic = z.q.sb.OW;
	$.Panorama.Events = z.event;
	$.TileLayer.PanoramaLayer = z.q.sb.QAa;
	$.UA = {
		ie: g.l.Gs,
		ielt9: g.l.Ve,
		ielt11: g.l.bsa,
	...
	$.Browser = {
		...
		mobileWebkit: g.l.lua,
		mobileWebkit3d: g.l.I6,
		mobileOpera: !!g.l.kua,
		retina: g.l.Kc,
		touch: !!g.l.Uf,
		msPointer: !!g.l.K6,
	...
	var Lc = {
		...
		isDOM: g.a.GJ,
		includes: g.a.ka,
		requestIdleCallback: g.a.sU,
		cancelIdleCallback: g.a.bQ,
		requestAnimFrame: g.a.Xc,
		cancelAnimFrame: g.a.si,
		color2RgbaArray: g.a.am,
		color2Rgba: g.a.Qna
	};
	for (Jc in Lc) Lc.hasOwnProperty(Jc) && "function" == typeof Lc[Jc] && ($.Util[Jc] = function() {
		var a = Jc;
		return function() {
			g.c.ya($.Util);
			g.c.add($.Util, a);
			return Lc[a].apply(g.a, Array.prototype.slice.call(arguments))
		}
	}());
	$.DomUtil = {
	...
	for (Jc in Mc) Mc.hasOwnProperty(Jc) && "function" == typeof Mc[Jc] && ($.DomUtil[Jc] = function() {
		var a = Jc;
		return function() {
			g.c.ya($.DomUtil);
			g.c.add($.DomUtil, a);
			return Mc[a].apply(g.f, Array.prototype.slice.call(arguments))
		}
	}());
	var Nc = g.o;
	$.User = {
	...
	g.Lj = g.da.extend({
		...
		On: function(a) {
			...
			this.Sia = g.a.bind(this.Kq, a || this)
		},
		update: function() {
			this.frames += 1;
			var a = +new Date,
	...
	g.Sb = g.da.extend({
		...
		A: function(a, b) {
			...
			g.o.TQ && this.X("editEnable", b);
			g.o.TQ && this.Dd ? this.X("style", b, !0) : this.X("styleUrl", b);
			...
			this.X("bounds", b);
			this.X("draw", b);
			this.bf("zoomAndCenter destroy defaultCursor jogEnable animateEnable baseRender overlayRender vectorMapForeign"
				.split(" "), b);
			this.bf("rotateEnable pitchEnable dragEnable keyboardEnable doubleClickZoom scrollWheel zoomEnable touchZoom"
				.split(" "),
				b, !0);
		...
		styleUrlChanged: function() {
			if (this.D.Ci) {
				...
				if (a !== this.Dm) {
					...
					if ("normal" === c) this.Dm = "", this.set("nolimg", !!this.D.get("nolimg_param")),
						this.set("style", ""), this.Pu = "";
					else {
						this.jA = !0;
						this.set("nolimg", !0);
						var d;
						32 > c.length ? d = g.o.Cc + "://webapi.amap.com/style2?name=" + c + "&key=" + g
							.o.key : (d = g.o.Cc + "://webapi.amap.com/v4/map/styles2?styleid=" +
								c + "&s=rsv3&key=" + g.o.key + (b ? "&ispublic=1" : ""), g.o.Xa ? d +=
								"&jscode=" + g.o.Xa : g.o.fv && (d = g.o.fv +
									"/v4/map/styles2?styleid=" + c + "&s=rsv3&key=" + g.o.key + (b ?
										"&ispublic=1" : "")));
						b = new g.kb.Ab(d, {
							callback: "callback"
						});
		...
		nqa: function(a) {
			...
			a = g.Ht.closestOnLine(b, a.fV().path);
		...
		nna: function() {
			...
			if (!a.contains(b)) {
				if (b instanceof g.vp) return this.nqa(a, b);
				var c = this.get("center").eb();
				a.wj() < b.wj() ? c.R = a.yi().R : (a.wc.R > b.wc.R && (c.R += a.wc.R - b.wc.R), a.oc
					.R < b.oc.R && (c.R += a.oc.R - b.oc.R));
				a.uj() < b.uj() ? c.Q = a.yi().Q : (a.wc.Q > b.wc.Q && (c.Q += a.wc.Q - b.wc.Q), a.oc
					.Q < b.oc.Q &&
					(c.Q += a.oc.Q - b.oc.Q));
				return c
			}
		...
		YO: function() {
			...
			this.D.refreshSize();
			var b = this.get("size");
			b && a && !b.hb(a) && (this.QU = b, this.jt = !0, this.set("display"), this.A8(b), this.get(
				"resizeEnable") && this.qa("resize", {
				Eua: a,
				U6: b
			}))
		},
		...
		Xga: function() {
			this.D.C = !0;
			this.QU = this.D.getSize();
			this.D.C = !1;
			if (g.l.Ve || g.l.E$ && g.l.GD || g.l.Zta) this.o0();
			else {
				var a = this;
				g.F.Zla(this.K,
					function(b) {
		...
		vsa: function() {
			...
			b.$S = g.f.create("a", a, "amap-logo");
			g.f.create("img", b.$S).src = g.l.Kc ? this.D.w.logoUrlRetina : this.D.w.logoUrl;
			b.sn = g.f.create("div", a, "amap-copyright");
			b.sn.style.display = "none";
			350 < g.f.nJ(this.K).width && (b.sn.innerHTML = this.D.w.copyright, b.sn.x6 = g.f.create(
				"span", b.sn, "amap-mcode"), this.vE());
			this.Ya = b
		},
		vE: function() {
			...
			if (a) {
				...
				this.D.C = !1;
				"GS(2021)6375" === c && a && "normal" !== a && "amap://styles/normal" !== a && (c = "",
					this.Ya.sn.style.visibility =
					"hidden");
				c && this.Ya.sn.x6 && (this.Ya.sn.x6.innerHTML = "- " + c + "\u53f7", this.Ya.sn.style
					.visibility = "visible");
				return c
			}
		},
		BY: function() {
			var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : !1;
			g.Oj && (a ? g.Oj.flush() : this.H3 || (this.H3 = g.a.Xc(function() {
				g.Oj.flush();
				this.H3 = null
			}, this)))
		},
		eU: function(a) {
			...
			c && (this.D.set("rasterLayer", void 0), this.D.f8 = !0, this.D.Wv = this.D.Ra, this.wi && (
				this.wi.xD = !1), c.q && (c.q.ZD = !0), a || (this.fU = g.a.sU(function() {
				b.fU = null;
				b.D &&
					b.D.tk(c)
			})));
			a && this.fU && g.a.bQ(this.fU)
		},
		Dr: function() {
			function a() {
				for (var a = d.get("layers"), b = d.get("zoom"), c = 0; c < a.length; c += 1) {
					var e = a[c].get("zooms");
					if (!(a[c].Aj || a[c].Wv || a[c].u5 || !e || b > e[1] || b < e[0] || !a[c].get(
								"visible") || a[c].q && a[c].q.ha && 0 === a[c].q.ha.length || a[c].q &&
							a[c].q.ZD || a[c].q && a[c].q.Ra)) return !1
				}
				a = d.D.get("features");
				return ("all" === a || g.a.ka(a, "point")) && d.Hc && d.Hc.get("visible") && 0 < d.Hc.ha
					.length && !d.Hc.Ra && !d.Hc.qo ? !1 : !0
			}
			...
			if (!this.xI)
				if (this.PS) this.BY();
					...
					var d = this,
						...
						f = a();
					e ? (e.q && e.q.Ra && (this.D.Ra || c()), f && (this.D.Ra || c(), this.eU(), b())) :
						f && (this.D.Ra || c(), b(), this.D.f8 = !0)
				}
		},
		layersChanged: function() {
			this.la = this.la || [];
			for (var a = this.get("layers"), b = this.la.length - 1; 0 <= b; b -= 1) this.la[b] === this
				.vd || this.la[b] === this.at || this.la[b].AB || this.la[b].S.AB || -1 !== g.a.indexOf(
					a,
					this.la[b].S) || (this.la[b].hg(), this.la[b].Ij && this.la[b].Ij.hg(), this.la[b].S
					.G("complete", this.Dr, this), this.la[b].S.G("renderComplete", this.Dr, this), this
					.la = g.a.Ho(this.la, b));
			for (var c = !1, d = !0, e = this.get("labelzIndex"), b = 0; b < a.length; b += 1)
				if (!a[b].u5)
					if (a[b].ri) - 1 === g.a.indexOf(this.la, a[b].q) && this.la.push(a[b].q);
					else {
						var f = this.cg(a[b]);
				...
				f.Hq && f.get("visible") && (c = !0, !1 === f.get("detectRetina") && (d = !1), e = f
					.get("textIndex") || e);
			this.Hc && (c || "3D" !== this.D.view.type ? this.Hc.qo = !1 : (c = g.a.find(a, function(
			a) {
				if (z.q.Jt && a instanceof z.q.Jt && a.get("visible")) return !0
			}), this.Hc.qo = c = !!c));
			a = g.a.indexOf(this.la, this.Hc);
			c && this.D.get("showLabel") ? (-1 === a && this.la.push(this.Hc), this.Hc.ja = d && g.l.ja,
					this.Hc.CC(this.get("mapStyle") || "normal"), this.Hc.set("zIndex", e), this.Hc.set(
						"visible", !0), this.D.wD = !0, this.D.get("isHotspot") ? this.Hc.Xua() : this
					.Hc.kQ()) :
				(this.Hc && (this.Hc.set("visible", !1), this.D.wD = !1, this.Hc.kQ()), this.D.wD = !1);
		...
		controlsChanged: function() {
			...
			if (a.add && 0 < a.add.length)
				for (; 0 < a.add.length;) b = a.add.shift(), (c = b.zu || b.addTo) && c.call(b, this.D,
					this.Ya.controls);
			else if (a.remove && a.remove.length)
				for (; 0 < a.remove.length;) b = a.remove.shift(), (c = b.Yv || b.removeFrom) && c.call(
					b, this.D, this.Ya.controls)
		},
		B1: function() {
			if (!this.xI) {
				var a =
					this;
				this.G1 = !1;
				a.vd || (a.vd = new g.q.hd(new z.q.hd, a), a.vd.Bf = 36, a.vd.jg = 36, a.vd.set(
					"zIndex", 120), a.la.push(a.vd), a.vd.YC = !0);
				for (var b = a.get("overlays"), c = [], d = 0; d < a.Wc.length; d += 1) - 1 === g.a
					.indexOf(b, a.Wc[d].Mb) && (a.Wc[d].Mb instanceof z.B.Ze || a.Wc[d].Mb instanceof z
						.B.Un ? a.Wc[d].hg() : (a.vd && a.Wc[d] instanceof g.B.wb ? (a.vd.bh = g.a.Ey(a
								.vd.bh, a.Wc[d].L), a.vd.m8([a.Wc[d].L])) : a.at && a.at.m8([a.Wc[d]
							.L]), a.Wc[d].L.fa ? (g.f.remove(a.Wc[d].L.fa), a.Wc[d].L.fa = null) : a.Wc[
								d].L.Ma && (g.f.remove(a.Wc[d].L.Ma.Ph),
								g.f.remove(a.Wc[d].L.Ma.Rc), g.f.remove(a.Wc[d].L.Ma.dir), a.Wc[d].L
								.Ma = null), a.Wc[d].Hn && a.Wc[d].Hn.stop(), a.Wc[d].zh && a.Wc[d].zh
							.stop(), a.Wc[d].Mb.ri = !1, a.Wc[d].Mb.zl(), a.Wc[d].Mb.B = null, a.Wc[d]
							.Mb = null, a.Wc[d].L.Uoa(), a.Wc[d].L = null, a.Wc[d].zl(), a.Wc[d].De =
							null, a.Wc[d].ui(), a.Wc[d].map = null), c.push(a.Wc[d]));
				...
				g.a.pxa(function(b) {
					if (!b.ri && b.ah) {
						...
						c && (a.Wc.push(c), c instanceof g.B.Ze || c instanceof g.B.Un ?
							c.Vs(a) : c instanceof g.B.wb ? e.push(c.L) : f.push(c.L), b
							.ri = !0)
					}
				}, b);
				e.length && a.vd.ey(e);
				f.length && (a.at || (a.at = new g.q.hd(new z.q.hd, a), a.at.set("zIndex", 110), a.la
					.push(a.at)), a.at.ey(f));
				a.set("display", 0)
			}
		},
		overlaysChanged: function() {
			this.Wc = this.Wc || [];
			this.get("overlays") && 0 === this.get("overlays").length ? this.B1() : this.G1 || (g.a.Xc(
				this.B1, this), this.G1 = !0)
		},
		...
		infosChanged: function() {
			...
			if (a) {
				...
				var b, c = this;
				g.ub.load("overlay", function() {
					for (var d in a) a.hasOwnProperty(d) && (b = a[d], c.tm[d] = c.tm[d] ||
						new g.B.Ze(b, c))
				})
			}
		},
		Tma: function(a) {
			var b = null;
			if (a instanceof z.B.wb) b = new g.B.wb(a, this);
			else if (a instanceof z.B.Un) b = new g.B.Un(a, this);
			else if (a instanceof z.B.Ze) b = new g.B.Ze(a, this);
			else {
				var c = ["overlay"];
				"d" === this.get("overlayRender") ? (c.push("dvector"), g.l.Fn ? c.push("svg") : c.push(
					"vml")) : c.push("cvector");
				if (!this.Mza && !g.ub.KD(c)) {
					var d = this;
					g.ub.Gg(c, function() {
						this.Mza = !0;
						d.overlaysChanged()
				...
				a instanceof z.B.Ec ? b = new g.B.Ec(a, this) : a instanceof z.B.uA ? b = new g.B.uA(a,
						this) : a instanceof z.B.$b ? b = new g.B.$b(a, this) : a instanceof z.B.hh ?
					b = new g.B.hh(a, this) : a instanceof z.B.Gt ? b = new g.B.Ec(a, this) :
					a instanceof z.B.Nt && (b = new g.B.Ec(a, this))
			}
			return b
		},
		P3: function() {
			var a = this.Ee;
			this.Pu && (!this.Se || !this.Se.Jp || this.D && this.D.ls) && (a = "function" ===
				typeof this.Pu ? this.Pu(this.wi.P.zoom) : this.Pu);
			return a
		},
		LCa: function() {
			function a() {}
		...
		NK: function(a) {
			if (a)
				if (g.a.si(this.zE), g.l.Zl) {
					var b = this;
					setTimeout(function() {
						b.pc()
					}, 0)
				} else this.pc();
			else this.Gw || (this.zE = g.a.Xc(this.pc), this.Gw = !0)
		},
		pc: function() {
			this.zE = null;
			if (!this.xI) {
				...
				if (this.la && (a.size = this.D.get("size"), a.size.width &&
					...
					for (var b = this.D.view.type, c = [], d = 0, e = this.la.length; d < e; d += 1)
						this.la[d].Vf && this.la[d].Vf !== b ? this.la[d].Ra = !0 : (c.push(this.la[d]),
							this.la[d].Ij && c.push(this.la[d].Ij));
					c.sort(function(a, b) {
						var c = a.get("zIndex"),
							d = b.get("zIndex");
					...
					a.Y1 = 15E5 < a.size.width * a.size.height * c * c;
					...
					a.tua = !0;
					a.YH = this.YH;
					for (var b = !1, f, c = !1, d = 0; d < this.la.length; d += 1) this.la[d].Ei && this
						.la[d].S.get("visible") && a.P.zoom <= this.la[d].S.get("zooms")[1] && (a.jU = !
							0), this.la[d].ne().Kc && (b = !0);
					for (d = 0; d < this.la.length; d +=
						1) this.la[d].S.PP && a.jU && (!this.fj && this.la[d].S.get("visible") && (f =
						this.la[d].S.PP(), f.mFa = 1, f.zoom = a.P.zoom), c = !0);
					this.ob = [];
					c && f && this.ob !== f && (this.ob = f);
					a.ob = this.ob;
					a.Kc = b;
					...
					a.Oc = this.Oc;
					a.WJ = this.WJ;
					if (f = this.Ry()) f.pc(a), this.Gi = this.jR = this.WJ = !1
				}
			}
		},
		Qq: function(a) {
			if (!this.xI) {
				...
				if (this.la && (b.size = this.D.get("size"), b.size.width && b.size.height)) {
					for (var c = this.D.view.type, d = [], e = 0, f = this.la.length; e < f; e += 1)
						this.la[e].Vf &&
						this.la[e].Vf !== c || !(this.la[e] instanceof g.q.Pm) || 0 > a.indexOf(this.la[
							e].S) || (d.push(this.la[e]), this.la[e].Ij && d.push(this.la[e].Ij));
					d.sort(function(a, b) {
						var c = a.get("zIndex"),
							d = b.get("zIndex");
						return c > d ? 1 : c === d ? a.hx > b.hx ? 1 : -1 : -1
					...
					b.Y1 = 15E5 < b.size.width * b.size.height * a * a;
		...
		Ry: function() {
			if (!this.J ||
				this.J.type !== this.D.view.type || this.J.Ota)
		...
		destroyChanged: function() {
			...
			this.eU(!0);
			this.V = {};
			this.Hc && (this.Hc.S.G("complete", this.Dr, this), this.Hc.hg(), this.la = g.a.Ho(this.la,
				g.a.indexOf(this.la, this.Hc)));
			this.Se && this.Se.je && this.Se.je.S && this.Se.je.S.setMap();
			this.Qka && clearTimeout(this.Qka);
			this.uka();
			this.xha();
			this.BO && this.BO();
			this.Ala();
		...
		drawChanged: function() {
			...
			if (d) {
				this.uq || (this.uq = []);
				b = 0;
				for (c = this.uq.length; b < c; b += 1) this.uq[b].ywa();
				...
				for (b = 0, c = this.uq.length; b < c; b += 1) this.uq[b].ywa(), this.uq[b].hDa(), this
					.G("click", this.uq[b].UEa, this)
		},
		Zd: function(a, b, c) {
		...
		G4: function(a, b) {
			...
			for (var e = -(c.width - a) / 2, c = -(c.height - b) / 2, f = d.getContext("2d"), h = this
					.Ya.q.childNodes, k = [], l = 0; l < h.length; l += 1) k.push(h[l]);
			k.sort(function(a, b) {
				return a.style.zIndex - b.style.zIndex
			});
			for (l = 0; l < k.length; l += 1) {
				var m = k[l];
				if (g.f.An(m, "amap-layer") || g.f.An(m, "amap-e") || g.f.An(m, "amap-labels"))
					if ("CANVAS" === m.tagName) {
						var h = c,
							n = e,
	...
	g.Sb.Ib({
		mga: function() {
			this.FB = !1;
			g.l.Uf && ("3D" === this.D.view.type ? this.Jca() : this.Hca());
			g.l.ba || this.Eca()
		},
		uka: function() {
			g.l.Uf && ("3D" === this.D.view.type ? this.Cha() : this.Bha());
			g.l.ba || (this.yha(), this.o_())
		},
		rotateEnableChanged: function() {
			this.fxa = this.get("rotateEnable");
			g.l.Uf && this.a2 && "3D" !== this.D.view.type && (this.fxa ? this.a2() : this.Dua())
		},
		zoomEnableChanged: function() {
			this.get("zoomEnable") ? (g.l.Uf && this.RP && "3D" !== this.D.view.type && this.RP(), g.l
				.ba || this.Gca()) : (g.l.Uf && this.jT && this.jT(),
				g.l.ba || this.o_())
		},
		...
		Mi: function(a, b, c, d) {
			...
			g.l.Uf && ("touchend" !== a.type ? this.V.Sga = h : h = this.V.Sga);
			f.Db = h;
			f.Ta = this.zg(h);
			f.Ta && (f.Ta = f.Ta.toFixed(3));
			f.Of = this.Qd(f.Ta);
			c || (c = this.FB ? this.FB ? [this.FB] : null : this.cfa(f.Ta, d)) && 0 < c.length && c[0]
				.vo && (e = c[0].vo, f.uu = c[0]);
			e || "info" === a.af || (e = this);
			f.kd = e;
			f.KBa = a.altKey;
			f.ctrlKey = a.ctrlKey;
			f.button = void 0 ===
				a.button ? 0 : a.button;
			f.xT = a;
			e && "AMap.LabelMarker" === e.CLASS_NAME && (f.lnglat = f.Of, f.pixel = f.Db, f.target = e,
				f.data = e.XW, f.originEvent = a);
		...
		TO: function() {
			var a = this.V;
			a.gg && (a.bk.Db.x === a.gg.x && a.bk.Db.y === a.gg.y ? a.Kf = !1 : (a.Kf = !0, a.Gp || (a
					.kq.r("dragstart", a.jq), a.Gp = !0), a.kq.r("dragging", a.bk), a.gg = a.bk
				.Db))
		},
		Wxa: function(a) {
	...
	g.Sb.Ib({
		tga: function() {
			this.Vm = {};
			this.h("moveend", this.i7, this);
			g.l.Zl && (g.l.sL || g.l.XH) && this.h("zoomend", this.KV, this);
			this.h("movestart", this.j7, this);
			this.h("zoomstart", this.q7, this);
			this.h("zoomend", this.p7, this);
			this.IM();
			this.jB = 0;
			this.GY = {};
		...
		q7: function() {
			2 !== this.jB && 12 === this.get("zoom") && (this.jB = 1, g.a.kR.start(this.GY));
			this.fj = !0
		},
		p7: function() {
			1 === this.jB && 13 !== this.get("zoom") && (this.jB = 0, g.a.kR.cancel(this.GY));
			this.fj = !1;
			this.set("display")
		},
		X0: function(a, b) {
		...
		xha: function() {
			this.G("moveend", this.i7, this);
			g.l.Zl && (g.l.sL || g.l.XH) && this.G("zoomend", this.KV, this);
			this.G("movestart", this.j7, this);
			this.G("zoomstart", this.q7, this);
			this.G("zoomend", this.p7, this);
			this.zha()
		},
		i7: function(a) {
			this.Kf = !1;
			this.ou();
			this.A8();
			!a.P5 && this.D.get("limitBounds", null, !0) ? (a = this.nna()) && !a.hb(this.get(
				"center")) ?
				this.XK(this.get("zoom"), a, !1, !0) : this.qa("moveend") : this.qa("moveend");
			this.set("display")
		},
		j7: function() {
			this.Kf = !0;
		...
		dragEnableChanged: function() {
			(this.ZC = this.get("dragEnable")) ? this.HM(): this.AO()
		},
		qa: function(a, b) {
			if (this.D.we(a)) {
				var c;
		...
		IM: function() {
			this.h("click", this.A_);
			this.h("dblclick", this.E_);
			g.l.Uf && this.yX();
			g.l.ba || this.Fca()
		},
		zha: function() {
		...
		HM: function() {
			this.ZC && ("3D" === this.D.view.type ? (this.h("dragstart", this.K_), this.h("dragging",
				this.G_), this.h("dragend", this.I_)) : (this.h("dragstart", this.J_), this.h(
				"dragging", this.F_), this.h("dragend", this.H_)))
		},
		AO: function() {
			this.ZC || ("3D" === this.D.view.type ? (this.G("dragstart", this.K_), this.G("dragging",
				this.G_), this.G("dragend", this.I_)) : (this.G("dragstart", this.J_), this.G(
				"dragging", this.F_), this.G("dragend", this.H_)))
		},
		J_: function(a) {
			this.YS(a);
			this.ou();
		...
		F_: function() {
			...
			if (c || b) {
				...
				(d = this.z2(a)) && (c = Math.round(this.Zd(d).bb(this.Zd(a)).y));
				this.ap(this.Ya.Zr, b, c);
				a.x =
					(a.x + g.a.Fa) % g.a.Fa;
				this.set("centerCoords", a, !0);
				this.set("center", this.Qd(a), !0);
				this.yv && (this.ih ? (a = new Date, this.$t = 100 < a - this.ih ? new g.H(0, 0) : new g
					.H(b, c), this.ih = a) : this.ih = new Date);
				this.qa("dragging");
				this.qa("mapmove")
		...
		ap: function(a, b, c) {
			if (a && !(1 > Math.abs(b) && 1 > Math.abs(c))) {
				var d = parseFloat(a.style.top) || 0,
					...
					f = "";
				this.rotation && (f = g.f.qt[g.f.qg] + ":rotate(" + this.rotation +
		...
		z2: function(a) {
			var b = this.D.view.aX(),
				c = this.QU.height * this.T / 2;
				...
				if (this.V.Kf) {
					...
					this.Ie.Kq = function(a) {
						if (2 > Math.abs(a.x) && 2 > Math.abs(a.y)) this.Ie.stop(),
							this.r("moveend"), this.ws(), this.$t = this.ih = null;
						else {
							var b = a.x,
								e = a.y,
								f = this.rotation;
	...
	g.Sb.Ib({
		setZoomSlow: function(a) {
			this.XK(a, null, !this.get("animateEnable"))
		},
		setPanTo: function(a) {
			this.XK(null, a, !this.get("animateEnable"))
		},
		zoomAndCenterChanged: function(a) {
			var b = a[0];
			b < this.get("zooms")[0] && (b = this.get("zooms")[0]);
			b > this.get("zooms")[1] && (b = this.get("zooms")[1]);
			this.XK(b, a[1], a[2] || !this.get("animateEnable"))
		},
		zoomChanged: function() {
	...
	g.QW = g.da.extend({
		...
		centerCoordsChanged: function() {
			...
			a instanceof g.U ? c.x = (c.x + 268435456) % 268435456 : 0 > c.x ? c.x = 0 : c.x > b.Ic && (
				c.x = b.Ic);
	...
	g.PF = g.QW.extend({
		lm: function() {
			var a = this.get("size"),
				...
				e = new g.Xf(b.bb(a.Pd(e)), b.add(a.Pd(e))),
				c = this.map.get("targetLevel");
			if (c > d - 1) {
				var f = Math.pow(2, 20 - c);
				e.P$ = new g.Xf(b.bb(a.Pd(f)), b.add(a.Pd(f)))
			}
			e.H9 = c || d;
			e.Ac = a;
			return e
	...
	g.sM = g.QW.extend({
		...
		jr: function() {
			if (!this.Dza() && (this.uL(), this.Voa(), this.map)) {
				var a = this,
					b = function() {
						a.map.camera = a.T3();
						a.map.r("camerachange", {
							map: a.map,
							camera: a.map.camera
						})
					};
		...
		Wo: function() {
			...
			return g.a.eg() - this.Tga > a
		},
		uL: function() {
			var a = this.get("centerCoords"),
				b = this.get("pitch"),
				c = this.get("rotation"),
				d = (new g.Dc).e9(-a.x + g.a.ec.x, -a.y + g.a.ec.y, 0);
			this.$ma = {
				x: a.x - g.a.ec.x,
				y: a.y - g.a.ec.y
			};
			a = (new g.Dc).Tz(180 - b, 1, 0, 0);
			this.K7 = (new g.Dc).set(a);
			c = (new g.Dc).Tz(c, 0, 0, 1);
			this.Uq = (new g.Dc).set(c);
			this.bqa = d.Eg();
			this.dc = (new g.Dc).e9(0, 0, -this.qn).multiply(a.multiply(c.multiply(d))).toFixed(8);
		...
		Dza: function(a) {
			...
			this.uz = this.qn / 10;
			this.NI = 50 * this.qn;
			this.Eoa = (this.qn - this.uz) / (this.NI - this.uz);
			this.Me.b9(a, c, this.uz, this.NI);
			...
			var c = new g.gW,
				...
				t = e[14],
				e = e[15];
			xc(b[0], k - d, p - l, u - q, e - v).normalize();
			xc(b[1], k + d, p + l, u + q, e + v).normalize();
			xc(b[2], k + f, p + m, u + r, e + w).normalize();
			xc(b[3], k - f, p - m, u - r, e - w).normalize();
			xc(b[4], k - h, p - n, u - s, e - t).normalize();
			xc(b[5], k + h, p + n, u + s, e + t).normalize();
			a.oR = c
		},
		tD: function() {
			var a = this.map;
		...
		lm: function() {
			...
			var e = new g.H(0, d);
			c = this.zg(e, !0);
			if (55 < this.De.pitch || !c)
				for (; !c;) d += a / 40, e.y = d, c = this.zg(e, !0);
			this.top = d / a;
			e.x = b;
			d = this.zg(e, !0);
			var f = 0,
		...
		zg: function(a, b, c) {
			...
			a = f.Bh(d).elements;
			c = (e[2] - (-c || 0)) / (e[2] - a[2]);
			if (0 > a[2] || 0 > c || b && c > 2.5 * this.Eoa) return null;
			b = e[0] - c * (e[0] - a[0]);
			c = e[1] - c * (e[1] - a[1]);
			return isNaN(b) || isNaN(c) ? null : (new g.H(b, c)).add(g.a.ec)
		},
		L6: function(a) {
			for (var b = this.get("centerCoords"), c = g.a.ec.x, d = g.a.ec.y, e = this.get("size"), f =
					g.a.Fa, h = b.x + f / 2, b = b.x - f / 2, k = [], l = new g.Gl([0, 0, 0, 1]), m = l
					.elements, n = new g.H(0, 0), p = g.Dc.multiply(this.Me, this.dc), q = 0, r = a
					.length; q < r; q++)
				if (a[q]) {
	...
	g.Sb.Ib({
		u2: function(a, b, c) {
			var d = this;
			d.kF ? (clearTimeout(d.kF), d.kF = null) : (d.qa("zoomstart", {
				zoom: a
			}), d.r("zoomstart"));
		...
		sA: function(a, b, c, d) {
			...
			if (e !== a) {
				...
				c = function(c) {
					...
					this.set("zoom", c);
					var e = this.zg(l),
						d = e && e ? e.bb(d) : new g.H(0, 0);
					this.set("centerCoords", this.get("centerCoords").bb(d).toFixed(3));
					d.x && d.y && this.qa("mapmove");
					c === a && a << 0 === a && (this.set("targetLevel", null), h && !this.kF && (
							this.qa("zoomchange"), this.qa("zoomend")), this.r("zoomend"), k &&
						this.r("moveend"), this.Wf = null)
				};
				var m;
				this.Hd && this.Hd.dw && (this.Hd.stop(), this.Hd.gS && (d = !0), this.Hd.uD && (m = !
					0), this.Hd = null, this.set("targetLevel",
						null));
				this.Wf && this.Wf.dw && (this.Wf.stop(), d = !0, this.Wf.uD && (m = !0), this.Wf =
					null, this.set("targetLevel", null));
				h && !d && this.qa("zoomstart");
				k && !m && this.qa("movestart");
				this.r("zoomstart");
				b ? c.call(this, a) : (this.Wf = new g.Lj(e, a, null, 0.04), this.Wf.gS = h, this.Wf
					.uD = k, this.Wf.transition = function(a, b, c) {
		...
		XK: function(a, b, c, d) {
			var e = null;
			a || (a = this.Hd ? this.Hd.mya : this.get("targetLevel") || this.get("zoom"));
			var e = b ? this.Cb(b).toFixed(3) : this.Hd ? this.Hd.G9 : this.get("centerCoords"),
				f = a !== this.get("zoom"),
				h = !e.hb(this.get("centerCoords")),
				k = b = !1;
			this.Wf && this.Wf.dw && (this.Wf.stop(), b = !0, this.Wf.uD && (k = !0), this.Wf = null,
				this.set("targetLevel", null));
			this.Hd && this.Hd.dw && (this.Hd.stop(), this.Hd.gS && (b = !0), this.Hd.uD && (k = !0),
				this.Hd = null, this.set("targetLevel", null));
			this.Ie && (this.Ie.stop(), this.Ie = null);
			if (f || h) {
				if (!this.D.view.lm().contains(e) || f && "3D" !== this.D.view.type && (g.l.ba || g.l
						.Ve)) c = !0;
				if (c) f && (b ||
					(this.r("zoomstart"), this.qa("zoomstart")), this.set("zoom", a), this.qa(
						"zoomchange"), this.qa("zoomend"), this.r("zoomend")), h && (k || d || (this
						.qa("movestart"), this.r("movestart")), this.set("centerCoords", e), this
					.qa("mapmove"), this.r("moveend", {
						P5: d
					})), this.set("targetLevel", null);
				else {
					this.set("targetLevel", a);
					var l = a - this.get("zoom"),
						m = e.bb(this.get("centerCoords")).toFixed(3);
					...
					this.Hd.Kq = function(b) {
						0.02 > b ? (this.Hd && (this.Hd.stop(), this.Hd = null), f && (this.set(
								"zoom", a), this.qa("zoomchange"), this.qa("zoomend"), f = !
							1, this.r("zoomend")), h && (this.set("centerCoords", e), this
							.r("mapmove"), this.r("moveend", {
								P5: d
							})), this.set("targetLevel", null)) : (f && this.set("zoom", a - l *
							b), h && (b = e.bb(m.Pd(b)).toFixed(3), this.set("centerCoords",
							b), this.qa("mapmove")));
						this.set("display", 1)
					};
					this.Hd.On(this);
	...
	g.q.Zb = g.da.extend({
		...
		hg: function() {
			...
			if (g.Ca && g.Ca.mr && g.Ca.mr.length) {
				var a = g.a.indexOf(g.Ca.mr, this); - 1 !== a && (g.Ca.mr = g.a.Ho(g.Ca.mr, a))
			}
			if (a = this.Ob) {
				if (a.length)
			...
			if (c)
				for (var d in g.Ca.Gj) g.a.eD(d, c) && delete g.Ca.Gj[d]
		},
		qa: function(a, b) {
			this.S.r(a, b)
		},
		...
		cJ: function() {
			...
			if (a) {
				if (a instanceof g.pe) {
					var b = a.ek(),
						a = a.Qo(),
						c = this.e.Cb(new g.U(180, 0)).x,
						d = this.e.Cb(b),
						e = this.e.Cb(a),
						f = this.e.get("center");
					b.R > a.R && (0 < f.R ? e.x += c : d.x -= c);
					this.I = [d.x, d.y, e.x, e.y]
				} else a instanceof g.Xf ? this.I = [a.kc.x, a.kc.y, a.Xd.x, a.Xd.y] : a instanceof g
					.QF && "3D" === this.S.Vf && (b = a.path[1], d =
						this.e.Cb(a.path[0]), e = this.e.Cb(b), this.I = [d.x, d.y, e.x, e.y, a.Q8, a
							.height
						]);
				return this.I
			}
	...
	g.pg = g.da.extend({
		...
		AHa: function(a) {
			this.Kp !== a && (this.Kp = a | 0) && this.w1(this.Kp)
		},
		Nd: function(a) {
			return !!this.e[a]
		},
		...
		set: function(a, b) {
			var c = this.yY(a);
			c ? c.value = b : (c = new g.pg.vr(a, b), this.e[a] = c, this.vB(c), this.count += 1, this
				.count > this.Kp && this.w1(this.Kp))
		},
		Cw: function(a) {
			this.remove(a)
		},
		...
		sza: function(a) {
			a = new g.pg.vr("", a);
			0 === this.count ? (this.dd.Ia = null, a.Ia = this.dd, this.kC = this.dd.next = a) : (this
				.dd.next.Ia = a, a.next = this.dd.next, a.Ia = this.dd, this.dd.next = a);
			this.count += 1
		},
		wua: function() {
			if (this.count) {
				this.count -= 1;
				var a = this.dd.next;
				a.next ? (a.next.Ia = this.dd, this.dd.next = a.next) : (this.dd.next = null, this.kC =
					this.dd.Ia = null);
				a.next = null;
				a.Ia = null;
				return a.value
		...
		pop: function() {
			return this.p0(this.dd.Ia)
		},
		yY: function(a) {
			if (this.e.hasOwnProperty(a)) return a = this.e[a], this.WF && (a.remove(), this.vB(a)), a
		},
		vB: function(a) {
			this.WF ? (a.next = this.dd.next, a.Ia = this.dd, this.dd.next = a, a.next.Ia = a) : (a.Ia =
				this.dd.Ia, a.next = this.dd, this.dd.Ia = a, a.Ia.next = a)
		},
		w1: function(a) {
			if (!(this.count <= a || this.count < 2 * this.EB.length)) {
				for (var b = this.WF ? this.dd.Ia : this.dd.next, c = {}, d = 0, e = this.EB.length; d <
					e; d++) c[this.EB[d]] = !0;
				for (a = Math.ceil(2 * a / 3); b && this.count > a && (d = this.WF ? b.Ia : b.next, b
						.key && !c[b.key] && this.WB(b) && this.kK(b.value),
	...
	function Rc(a, b, c) {
		...
		clearTimeout(a.Aya);
		var d = a.Jta;
		d.Mn.remove(a.url) && d.Uga();
		d = a.Osa ? a.ha : a.Ba;
		a.ha = null;
		(c || b || a.iR) && a.Nc(b ? d : null, a);
		a.X5 ? (a.X5.ui(), a.X5 = null) : d && (d.onload = null, d.onerror = null, d.onabort = null, a.Ba = null)
	}
	g.yF = g.da.extend({
		MBa: "assets/image/blank.gif",
		A: function(a, b, c) {
			this.timeout = b || 15E3;
		...
		PM: function(a) {
			a && this.Mn.count >= this.O2 && (a = this.Mn.dd.Ia.value, a.rn && (this.Mn.remove(a.url),
				this.hX(a)));
			for (; this.Pq.count && !(this.Mn.count >= this.O2);) this.gea(this.Pq.shift())
		},
		Uga: function() {
			if (!this.RX) {
				this.RX = !0;
		...
		gea: function(a) {
			...
			a.startTime = +new Date;
			a.OK = !0;
			b.complete ? Rc(a, !0) : (this.Mn.set(a.url, a), b.onload = Qc(a, !0), b.onerror = Qc(a, !1,
				!0), b.onabort = Qc(a, !1), a.Aya = setTimeout(Qc(a, !1, !0), this.timeout))
		},
		hX: function(a) {
			a.OK && (Rc(a, !1), a.rn = !0, a.ICa = !0)
		},
		IFa: function(a, b, c) {
		...
		oz: function(a, b, c, d, e) {
			var f = this.Mn.get(a);
			if (f && f.rn) f.rn = !1, f.Nc = b, f.iR = c;
			else {
				f = new Pc(a, b, c);
				f.Osa = d;
				f.key = e;
		...
		yta: function(a, b, c) {
			var d = this.Mn.get(a);
			if (d && d.rn) d.rn = !1, d.Nc = b, d.iR = c;
			else {
				d = new Pc(a, b, c);
				d.fqa = !0;
		...
		clear: function(a) {
			...
			this.Pq.clear();
			if (a)
				for (; 0 < this.Mn.length;) a = this.Mn.pop(), this.hX(a);
			else this.Mn.forEach(function(a) {
				a.rn = !0
			})
		}
	});
	...
	g.rr = Sc;
	g.q.sb = g.q.Zb.extend({
		A: function(a, b, c, d, e) {
			arguments.callee.ma.apply(this, arguments);
			this.X("tileSize", a);
			this.X("tiles", a);
			this.bf(["zooms", "type", "detectRetina", "errorUrl"], a);
			a.HG && (this.X("lang", b, !0), this.X("mapStyle", b, !0), this.X("style", b, !0), this.X(
				"features", b, !0));
			...
			this.iL = c;
			this.X("reload", a);
			a.Ksa ? this.X("createTile", a) : this.X("tileFun", a);
			this.gf = d;
			this.pS = e
		},
		...
		ne: function() {
			...
			this.S.Jsa && (a = [Math.min(a[0], 18), Math.min(a[1], 18)]);
			return {
	...
	g.q.hd = g.q.Zb.extend({
		A: function(a, b) {
			...
			this.Nv = [];
			this.gm = new g.q.naa;
			a && (this.X("style", a), this.X("cursor", a, !0), this.Zxa = a.get("stable") || !1, this.X(
		...
		dataSourcesChanged: function() {
			...
			a && a.length ? "string" === typeof a ? (new g.kb.Ab(a)).h("complete", function(a) {
				...
				this.Ra = !0;
				this.S.r("complete")
			}, this) : a.length && (this.A7(a), this.ns = a, this.om = !0, this.set("display"), this
				.Ra = !0, this.S.r("complete")) : this.clear()
		},
		getDatas: function() {
			return this.ns
		},
		...
		qa: function(a, b) {
			var c = {
				type: a,
				data: "mouseout" === a ? this.Rga || null : b.uu.ib,
				target: this.S,
				originEvent: b.xT
			};
			this.Rga = "mouseout" === a ? null : b.uu.ib;
			this.S.r(a, c)
		},
		sc: function(a) {
			this.qa(a.type, a)
		...
		A7: function(a) {
			if (a) {
				...
				for (var b = 0; b < a.length; b += 1) {
					...
					c = this.map.Cb(c);
					c = new g.bi({
						name: "point-" + g.a.zb(this),
						W: new g.Aa.Ng([c.x, c.y], !0)
					});
					c.vo = this;
					c.ib = a[b];
					this.QH(c)
		...
		dra: function(a) {
			if ("geojson" === a) return new g.taa({
				map: this.map
			});
			if ("topjson" === a) return new g.hBa({
				map: this.map
			});
			if ("subway" === a) return new g.cBa({
				map: this.map
			})
		},
		Kva: function(a) {
				...
				if (a.rules) {
					for (var b = a.rules, d = 0, e = b.length; d < e; d += 1) {
						for (var f = [], h = b[d].symbolizers, k = 0, l = h.length; k < l; k += 1) h[k]
							.fill && (f[k] = new g.style.Og.eW(h[k].fill)), h[k].stroke && (f[k] = new g
								.style.Og.JW(h[k].stroke));
						h = f;
						b[d].fL = h;
						b[d] = new g.style.lba(b[d])
					}
					c.rules = b
				}
				if (a.symbolizers) {
					b = a.symbolizers;
					a = 0;
					for (d = b.length; a < d; a += 1) b[a].fill && (b[a] = new g.style.Og.eW(b[a]
						.fill)),
						b[a].stroke && (b[a] = new g.style.Og.JW(b[a].stroke));
					c.fL = b
				}
				a = new g.nM(c)
			} else a = new g.nM({});
		...
		lwa: function(a) {
			"px" === a.target.get("unit") ? (this.Bf = Math.max(a.ul, this.Bf), this.jg = Math.max(a.ul,
				this.jg)) : a.ul > this.Ps && (this.Ps = a.ul, this.rz = this.Ps / this.map.D.nj.oq(
				20))
		},
		QH: function(a) {
			this.gm.add(a);
			if (!this.YC &&
				...
				if (0 === a.name.indexOf("circle") || 0 === a.name.indexOf("ellipse")) {
					a.h("rad", this.lwa, this);
					var b = a.get("radius");
					b.length && (b = Math.max.apply(null, b));
					"px" === a.get("unit") ? (this.Bf = Math.max(b, this.Bf), this.jg = Math.max(b, this
						.jg)) : this.Ps ? b > this.Ps && (this.Ps = b, this.rz = this.Ps / this.map
						.D.nj.oq(20)) : (this.Ps = b, this.rz = this.Ps / this.map.D.nj.oq(20))
				}
				b = a.get("strokeWeight") || 0;
				if (!this.sz || b > this.sz) this.sz = b
			}
			this.Zxa || a.X("feature", this, !0)
		},
		ey: function(a) {
			this.om = !0;
		...
		BEa: function(a) {
			var b, c = this.get("style"),
				d = a.vl;
			c instanceof g.nM || (c = this.Kva(c));
			if (d && 0 < d.length) b = c.S2(d, a);
			else {
				if (c.K8.length || c.vl.length) b = c.roa(a);
				b || (b = a.Gqa())
			}
			return b
		},
		...
		featureChanged: function(a) {
			...
			var b = a.target,
				c = b.fc();
			0 !== this.gm.Lqa([g.a.zb(b)]).length && (this.gm.remove(b, a.Pv), c && !a.Koa && this.gm
				.add(b))
		},
		m8: function(a) {
			this.om = !0;
		...
		sHa: function(a) {
			return a.HEa() === g.q.mBa.WAa
		},
		bm: function(a) {
			return this.YC ? new g.M.Le.Hl(this, a) : "c" === this.map.get("overlayRender") && g.M
				.canvas.Hl ? new g.M.canvas.Hl(this, a) : g.M.ce.Hl && "d" === this.map.get(
					"overlayRender") ? new g.M.ce.Hl(this, a) : null
		}
	});
	g.q.hd.Ib({
		cm: function(a) {
			return this.YC ? new g.Ea.Le.Hl(this, a) : this.S.Aj ? new g.Ea.Uaa(this, a) : new g.Ea.Hl(
				this, a)
		}
	});
	g.q.naa = g.da.extend({
		...
		add: function(a) {
			var b = g.a.zb(a),
				c = a.fc();
			this.sq[b] || (this.count += 1, this.sq[b] = a, c && !g.I.hb(c.Md(), [Infinity, Infinity, -
				Infinity, -Infinity
			]) && this.PT.Is(c.Md(), a))
		},
		vEa: function() {
		...
		remove: function(a, b) {
			var c = g.a.zb(a).toString(),
				d = a.fc();
			this.sq[c] && (this.sq[c] =
				null, d && (c = "undefined" !== typeof b ? b : d.Md(), this.PT.remove(c, a)))
		}
	});
	g.Lk = g.da.extend({
		A: function(a) {
			this.B6 = "undefined" !== typeof a ? a : 6;
			this.XJ = Math.floor(this.B6 / 2);
			this.SK = {
		...
		tna: function(a, b) {
			...
			do {
				...
				for (var h = f.length - 1; 0 <= h; h -= 1) {
					...
					var l = g.Lk.Vz(k.I[2] - k.I[0], k.I[3] - k.I[1], k.Kb.length + 1),
						k = g.Lk.Vz((k.I[2] > a.I[2] ? k.I[2] : a.I[2]) - (k.I[0] < a.I[0] ? k.I[0] : a
		...
		z5: function(a, b) {
			var c;
			if (0 === b.Kb.length) b.I = g.I.eb(a.I), b.Kb.push(a);
			else {
				var d = this.tna(a, b),
					e = a;
				do {
					if (c && "undefined" !== typeof c.Kb && 0 === c.Kb.length) {
						var f = c;
						c = d.pop();
						for (var h = 0, k = c.Kb.length; h < k; h += 1)
							if (c.Kb[h] === f || 0 === c.Kb[h].Kb.length) {
								c.Kb.splice(h, 1);
								break
							}
					} else c = d.pop();
					...
					if ("undefined" !== typeof e.We || "undefined" !== typeof e.Kb || f) {
						...
						if (c.Kb.length <= this.B6)
							if (0 < d.length) e = {
								I: g.I.eb(c.I)
							};
							else break;
						else e = f = this.nta(c.Kb), 1 > d.length && (c.Kb.push(f[0]), d.push(c), e = f[
							1])
		...
		nta: function(a) {
			for (var b = this.Pva(a); 0 < a.length;) this.Qva(a, b[0], b[1]);
			return b
		},
		Pva: function(a) {
			for (var b =
		...
		Qva: function(a, b, c) {
			for (var d = g.Lk.Vz(b.I[2] - b.I[0], b.I[3] - b.I[1],
						b.Kb.length + 1), e = g.Lk.Vz(c.I[2] - c.I[0], c.I[3] - c.I[1], c.Kb.length +
				...
				var m = a[l],
					...
					n = Math.abs(g.Lk.Vz(n[1] - n[0], n[3] - n[2], b.Kb.length + 2) - d),
					m = [c.I[0] < m.I[0] ? c.I[0] : m.I[0], c.I[2] > m.I[2] ? c.I[2] : m.I[2], c.I[1] <
						m.I[1] ? c.I[1] : m.I[1], c.I[3] > m.I[3] ? c.I[3] : m.I[3]
					],
					m = Math.abs(g.Lk.Vz(m[1] - m[0], m[3] - m[2], c.Kb.length + 2) - e),
					p = Math.abs(m - n);
				if (!h || !f || p < f) h = l, f = p, k = m < n ? c :
					b
			}
			d = a.splice(h, 1)[0];
			b.Kb.length + a.length + 1 <= this.XJ ? (b.Kb.push(d), g.I.extend(b.I, d.I)) : c.Kb.length +
				a.length + 1 <= this.XJ ? (c.Kb.push(d), g.I.extend(c.I, d.I)) : (k.Kb.push(d), g.I
					.extend(k.I, d.I))
		},
		remove: function(a, b) {
			var c = [];
			...
			if (!1 === c[1]) {
				var d = 0,
					e = [];
				do d = e.length, e = e.concat(this.p8.apply(this, c)); while (d !== e.length);
				return e
			}
			return this.p8.apply(this, c)
		},
		p8: function(a, b, c) {
			var d = [],
				e = [],
			...
			do {
				...
				if ("undefined" !== typeof b)
					for (; 0 <= k;) {
						var l = c.Kb[k];
						if (g.I.$g(a, l.I))
							if (b && "undefined" !== typeof l.We && l.We === b || !b && ("undefined" !==
									typeof l.We || g.I.P2(a, l.I))) {
								"undefined" !== typeof l.Kb ? (f = this.Pz(l, !0, [], l), c.Kb.splice(k,
									1)) : f = c.Kb.splice(k, 1);
								g.Lk.ZT(c);
								b = void 0;
								c.Kb.length < this.XJ && (h = this.Pz(c, !0, [], c));
								break
							} else "undefined" !== typeof l.Kb && (e.push(k), d.push(c), c = l, k = l.Kb
								.length);
						k -= 1
					} else if ("undefined" !== typeof h) {
						c.Kb.splice(k + 1, 1);
						0 < c.Kb.length && g.Lk.ZT(c);
						k = 0;
						for (l = h.length; k < l; k += 1) this.z5(h[k], c);
						h.length = 0;
						0 === d.length && 1 >= c.Kb.length ? (h = this.Pz(c, !0, h, c), c.Kb.length = 0,
							d.push(c), e.push(1)) : 0 < d.length && c.Kb.length < this.XJ ? (h =
							this.Pz(c, !0, h, c), c.Kb.length = 0) : h = void 0
					} else g.Lk.ZT(c)
			} while (0 < d.length);
			return f
		},
		...
		Pz: function(a, b, c, d, e, f) {
			...
			do {
				...
				for (var l = d.length - 1; 0 <= l; l -= 1) {
					var m = d[l];
					if (g.I.$g(a.I, m.I))
						if ("undefined" !== typeof m.Kb) k.push(m.Kb);
						else if ("undefined" !== typeof m.We)
						if (b) c.push(m);
						else if ("undefined" === typeof e || m.type === e) m = m.We, "undefined" !==
						typeof f ? h[g.a.zb(m)] = m : c.push(m)
				}
			} while (0 < k.length);
	...
	g.B.Fh = g.da.extend({
		ka: [g.va, g.$e],
		uva: ["position", "altitude", "visible", "clickable", "bubble"],
		A: function(a, b) {
			this.map = b;
			this.bf(this.uva, a);
			this.X("zIndex", a);
		...
		draggableChanged: function() {
			this.get("draggable") ? this.HM() : this.AO()
		},
		qa: function(a, b) {
			var c;
			c = b ? {
		...
		clickableChanged: function() {
			this.get("clickable") ? this.GM() : this.y1()
		},
		Ica: function() {
			this.get("clickable") && this.GM();
		...
		eu: function(a) {
			...
			if ("2D" == b) {
				...
				this.ap(new g.H(e, b));
				this.qa("dragging", a)
			} else "3D" == b && a.Ta && (c = a.Db.bb(this.gg), b = c.x, c = c.y, e = a.Ta.bb(this.b6), a
				.Of.bb(this.a6), this.gg = a.Db, "function" === typeof this.tz && this.tz(b,
					c, e), this.b6 = a.Ta, this.a6 = a.Of, this.qa("dragging", a))
		},
		fu: function(a) {
			this.map.Aw();
		...
		AN: function(a) {
			var b, c, d = [];
			if (a)
				for (b = 0, c = a.length; b < c; b += 1) d.push(this.BN(a[b]));
			return d
		},
		BN: function(a) {
			a = this.map.Cb(a);
		...
		Ut: function(a, b) {
			...
			if (e)
				for (var e = 0, f = a.length; e < f; e++) {
					...
					for (e = 0, f = a.length; e < f; e++) h = c.Cb(a[e]), h.x += b[0], h.y += b[1], d
						.push(c.Qd(h));
			return d
		}
	});
	g.B.wb = g.B.Fh.extend({
		hE: "content contentDom icon opacity angle autoRotation offset textAlign verticalAlign shadow title label isTop shape topWhenClick topWhenMouseOver noSelect anchor"
			.split(" "),
		fma: {
		...
		SN: function(a, b, c) {
			...
			if (d && "AMAP_ANIMATION_NONE" !== d) {
				...
				this.Hn.transition = function(c, h, k) {
					...
					return e.fma[d][c](k % 600 / 600)
				};
				c = c || 40;
				this.Hn.Kq = function(a) {
					e.set("AnimationOffset", e.DO.add(new g.H(0, -1 * c * a)))
				};
				this.DO = new g.H(0, 0);
				this.Hn.On()
			}
		...
		A0: function() {
			this.Hn && (this.Hn.stop(), this.set("AnimationOffset", this.DO));
			this.set("AnimationOffset", new g.H(0, -40));
			if (this.pr) this.pr.set("position", this.get("position"));
			else {
				var a = new z.B.wb({
		...
		animationChanged: function() {
			this.Hn && (this.Hn.stop(), this.set("AnimationOffset", this.DO), this.Hn = null);
			var a = this.get("animation");
			a && "AMAP_ANIMATION_NONE" !== a && ("AMAP_ANIMATION_DROP" === a ? this.SN(!0, "in", 100) :
				this.SN())
		},
		sg: function() {
		...
		raiseOnDragChanged: function() {
			this.get("raiseOnDrag") ? (this.h("dragstart", this.A0, this), this.h("dragging", this.sg,
				this), this.h("dragend", this.mY, this)) : (this.G("dragstart",
				this.A0, this), this.G("dragging", this.sg, this), this.G("dragend", this.mY,
				this))
		},
		ap: function(a) {
		...
		Vma: function() {
			var a = this.get("content"),
				...
				d = this.get("label"),
				e, f = this;
			e = a ? this.f2(a, c) : this.VP(this.get("icon"), function() {
				f.L && f.L.fa ? (g.l.Ai && g.a.iepngFix(e), f.offsetChanged(), f.tL()) : f
					.map && f.map.set("display")
			});
			this.set("contentDom", e, !0);
			b && (a = this.l2(b, c), this.set("shadowDom", a, !0));
			d && d.content && this.set("labelDom", this.WP(d.content), !0)
		},
		WP: function(a) {
		...
		Hu: function() {
			...
			if (this.map && a && !this.L) {
				var b = this.map,
					...
					a = this.L =
					new g.bi({
						name: "marker-" + g.a.zb(this),
						map: b,
						W: new g.Aa.Ng([a.x, a.y])
					});
		...
		getParams: function() {
			return {
				...
				KJ: this.get("labelDom"),
				g9: this.get("shadowDom"),
				opacity: this.get("opacity"),
		...
		offsetChanged: function() {
			...
			if (this.map)
				if (this.L && this.L.fa) {
					...
					"2D" == c ? (c = this.map.Cb(this.get("position")), c = c.bb(this.L.Na).nd(Math.pow(
							2, 20 - this.map.get("zoom"))), this.L.fa && (this.L.fa.NB && this.L.fa
							.parentNode !== this.L.fa.NB ? this.map.set("display") : a(c))) : "3D" ==
						c && (c = this.get("position"), c =
							this.map.Ns(c, this.get("altitude")), this.L.fa && (this.L.fa.NB && this.L
								.fa.parentNode !== this.L.fa.NB ? this.map.set("display") : a(c)))
		...
		positionChanged: function() {
			if (this.L) {
				...
				this.map && (this.L.eba = !0, this.offsetChanged())
			}
		},
		...
		UF: function() {
			this.L &&
				(this.L.Xj = null, this.L.se = !0, this.map && (this.map.vd.nm = !0, this.map.set(
					"display")))
		},
		contentChanged: function() {
			if (this.L) {
				this.L.Xj = null;
				this.map.vd.nm = !0; - 1 === g.a.indexOf(this.map.vd.bh, this.L) && this.map.vd.bh.push(
					this.L);
				...
				this.L.fa ? (g.l.Ai && g.a.iepngFix(a), this.L.fa.appendChild(a), this.L.Vg = a, this
						.offsetChanged(), this.tL()) :
		...
		iconChanged: function() {
			if (this.L && !this.get("content")) {
				...
				this.get("offset");
				var b = this,
					c = this.VP(a, function() {
						b.L && b.L.fa ? (g.l.Ai && g.a.iepngFix(c), b.offsetChanged(), b.tL()) : b
		...
		titleChanged: function() {
			this.L && this.L.Vg && "string" === typeof this.get("title") && this.L.Vg && this.get(
				"title") && (this.L.Vg.title = this.get("title"))
		},
		tL: function(a, b) {
			a = a || this.get("label");
		...
		labelChanged: function(a) {
			...
			if (this.L && this.L.fa) {
				...
				a && a.content && (c = "", a.content && (c = this.WP(a.content), b.appendChild(c), this
					.tL(a, c)), this.set("labelDom", c))
			} else a && a.content ? this.set("labelDom", this.WP(a.content), !0) : this.set("labelDom",
				null)
		},
		isTopChanged: function() {
			var a = this.map.vd.kL,
				b = this.get("isTop"),
				c = this.get("zIndex");
			a ? a === this ? this.L && this.L.fa && (this.L.fa.style.zIndex = b ? this.map.vd.fr + 10 :
				c, this.map.vd.kL = b ? this : null) : (a.L && a.L.fa && (a.L.fa.style.zIndex = b ?
					a.get("zIndex") : this.map.vd.fr + 10), this.L &&
				this.L.fa && (this.L.fa.style.zIndex = b ? this.map.vd.fr + 10 : c), this.map.vd
				.kL = b ? this : a) : (this.map.vd.kL = this, this.L && this.L.fa && (this.L.fa
				.style.zIndex = b ? this.map.vd.fr + 10 : c))
		},
		visibleChanged: function() {
			this.L && this.L.fa && (this.get("visible") && !this.Mb.get("outOfZooms") ? this.L.fa.style
		...
		zIndexChanged: function() {
			...
			if (a > this.map.vd.fr) {
				this.map.vd.fr = a;
				var b = this.map.vd.kL;
				b && b.L && b.L.fa && (b.L.fa.style.zIndex = a + 10)
			}
			this.L && this.L.fa && (this.L.fa.style.zIndex = this.get("isTop") ? this.map.vd.fr + 10 :
				this.get("zIndex"))
		},
		opacityChanged: function() {
			var a = this.get("contentDom"),
		...
		moveChanged: function() {
			var a = this.get("move");
			if (!1 === a) return this.fya();
			void 0 !== a && ("pause" === a.action ? this.Nva() : "[object Array]" === Object.prototype
				.toString.call(a.Of) ?
				a.Of && ("resume" === a.action && this.PG ? this.moveTo(a.Of[a.Of.Mp || 0], a.speed,
					a.yb) : (this.PG && this.r("movestop"), a.Of.Mp = 0, this.set("position", a
					.Of[0]), this.pua(a.Of, a.speed, a.yb, a.xna))) : this.moveTo(a.Of, a.speed, a
					.yb, !0))
		},
		moveTo: function(a, b, c, d) {
			if (!(0 >= b)) {
				...
				this.zh.Kq = function(b) {
					...
					this.r("moving");
					b.hb(a) && (this.zh && (this.zh.stop(), this.zh = null), this.Mb.r("moveend", {
						target: this.Mb
					}), this.r("moveend"))
				};
				this.get("autoRotation") && !g.l.Ve && (b = "2D" == (this.map.D.view.type || "2D") ?
					this.$ea(e, a) : this.afa(e, a), this.set("angle", b));
				this.zh.On(this)
			}
		},
		fya: function() {
		...
		pua: function(a, b, c, d) {
			...
			function f() {
				a.Mp < a.length - 1 ? (a.Mp += 1, this.moveTo(a[a.Mp], b, c)) : (this.qa("movealong"),
					d ? (a.Mp = 0, this.set("position", a[0]), this.moveTo(a[a.Mp], b, c)) : this.r(
						"movestop"))
			}
	...
	g.B.Un = g.B.Fh.extend({
		...
		vt: function() {
			...
			if ("object" === typeof c) b.appendChild(c);
				...
				c.sort(function(a, b) {
					return isNaN(a.lK) || isNaN(b.lK) ? 0 : a.lK - b.lK
				});
		...
		Gm: function() {
			var a =
				this.map,
				b = this.K;
			a && b && (this.map.get("zoom"), b = this.get("position"), b = a.Ns(b), a = b.y, b = b.x,
				this.K.style.right = "", this.K.style.bottom = "", this.K.style.left = b + "px",
				this.K.style.top = a + "px")
		},
		hg: function() {
			this.K && (this.map.G("click", this.SBa, this), this.map.Ya.B.removeChild(this.K), this.Up
				.ri = !1, this.K = this.Up.De.map = null, this.map.G("movestart", this.bn, this),
				this.map.G("zoomstart", this.bn, this), this.map.G("click", this.bn, this), this.map
				.G("closeOverlays", this.bn, this), this.map.G("rotate", this.bn, this))
		},
		visibleChanged: function() {
	...
	g.B.Ze = g.B.Fh.extend({
		A: function(a, b) {
			arguments.callee.ma.apply(this, arguments);
			this.bf("content contentDom position contentU altitude isCustom autoMove showShadow closeWhenClickMap size offset anchor"
				.split(" "), a);
		...
		vt: function() {
			...
			if (a) {
				...
				if (b) {
					...
					e = this.msa = d = g.f.create("div", c, e);
					"string" === typeof a ? d.innerHTML = a : d.appendChild(a);
					this.boa = d;
					a = g.f.create("a", this.msa, "amap-info-close");
					a.innerHTML = "\u00d7";
					this.jQ = a;
		...
		BV: function() {
			...
			if (!a && b) {
				var a = this.LU,
					...
					c = b.height - 23,
					d = b.width;
				if (g.l.Ai || g.l.wv) c = this.qh.childNodes[0].offsetHeight, d = this.qh.childNodes[0]
					.offsetWidth + 26;
		...
		Gm: function() {
			...
			if (a && b && c) {
				...
				d = this.boa;
				if (this.jQ && d.childNodes[0]) {
					for (b = a = 0; b < d.childNodes.length; b += 1) a += d.childNodes[0]
						.clientHeight || 0;
					a > (this.get("size").height || d.clientHeight) ? this.jQ.style.right = "20px" :
						this.jQ.style.right = "5px"
				}
			}
		},
		Dda: function() {
		...
		pX: function() {
			if (this.get("position") && this.get("autoMove") && this.qh) {
				for (var a = this.map, b = new g.zd(this.qh.offsetWidth, this.qh.offsetHeight), c = a
						.Ns(this.get("position"), this.get("altitude")).add(this.Dda()), d = c.add(b
						.RE()), e = a.get("size"), f = a.yqa(),
					...
					0 === m[1] && 0 === m[2] ? (n = m[3] - (c.x + h), p = m[0] - (c.y + k), 0 < n && 0 <
							...
							3] ? (n = e.wj() - m[1] - (d.x + h), p = m[0] - (c.y + k), 0 > n && 0 < p &&
							(Math.abs(n) < Math.abs(p) ? h += n : k += p)) : 0 === m[0] && 0 === m[3] ?
						(n = e.wj() - m[1] - (d.x + h), p = e.uj() - m[2] - (d.y + k), 0 > n && 0 > p &&
							(Math.abs(n) < Math.abs(p) ? h += n : k += p)) : 0 === m[0] && 0 === m[1] &&
						(n = m[3] - (c.x + h), p = e.uj() - m[2] - (d.y + k), 0 < n && 0 > p && (Math
		...
		Pna: function() {
			this.get("closeWhenClickMap") && (this.map.h("clickstart", this.C_, this, !1), this.map.h(
				"clickend", this.B_, this, !1))
		},
		C_: function() {
			this.sf.ri && (this.sf.C = !0, this.sf.getIsOpen() && (this.sf.jL = !0), this.sf.C = !1)
		},
		B_: function() {
			this.sf.ri && (this.sf.jL && (this.sf.C = !0, this.sf.close(), this.sf.C = !1), this.sf
				.jL = !1)
		},
		hg: function() {
			this.Rc && this.map && (this.sf.jL = !1, this.get("closeWhenClickMap") && (this.map.G(
					"clickstart", this.C_, this), this.map.G("clickend", this.B_, this)), this.get(
					"retainWhenClose") ? this.map.Nl.appendChild(this.Rc) : (this.Rc.parentNode ===
					this.map.Ya.B && this.map.Ya.B.removeChild(this.Rc), this.sf.B = null), this
				.map = null, this.sf.ri = !1, this.Mb.r("close", {
					type: "close",
					target: this.Mb
				}))
		},
		...
		positionChanged: function() {
			this.map && this.Rc && (this.Gm(), this.pX())
		},
		anchorChanged: function() {
			this.positionChanged()
		},
		...
		U8: function(a) {
			...
			if (g.Aa.zp && this instanceof g.Aa.zp) {
				...
				for (var e, c = 0; c < b; c += 1)
					if (d = a[c], e = new g.Aa.UL(d), this.Rf[c] = e, 0 === c) {
						if (0 === d.length) break;
						e.vq(d) || d.reverse()
	...
	g.bi = g.da.extend({
		...
		Uoa: function() {
			...
			this.style = this.vl = this.vo = this.i6 = this.W = this.W.Oa = null;
			this.zl();
			this.ui()
		},
		sra: function() {
		...
		Jxa: function(a) {
			this.vl = a;
			this.zIndex = this.vl[0].Ik || this.zIndex
		},
		fc: function() {
			return this.W
		},
		DU: function(a) {
			a && (this.W = a, this.X("coords", a, !0), this.yB || this.UN) && (a.X("radius", this), a.X(
		...
		Gqa: function() {
			...
			a.zi() === g.Aa.Qe.GF || a.zi() === g.Aa.Qe.CF ? b.push(new g.style.Ce.Ec({
				...
				qb: 0.5,
				qc: 1
			})) : a.zi() === g.Aa.Qe.QL || a.zi() === g.Aa.Qe.qW || a.zi() === g.Aa.Qe.aM ? b.push(
				new g.style.Ce.yp({
					color: "#888888",
					width: 1,
					zIndex: 10
				})) : a.zi() !== g.Aa.Qe.Xw && a.zi() !== g.Aa.Qe.bM || b.push(new g.style.Ce.di({
					...
					for (var e = f.bh, h = !0, k = [], l = 0; l < e.length; l += 1) {
						...
						if (m)
							if (m.parentNode && m.parentNode.parentNode && this.J && m.parentNode
								.parentNode !== this.J.Nl && "none" !== m.parentNode.style.display) {
								var n = g.f.No(m),
									m =
									n[0],
									n = n[1];
				...
				if (e = f.yn([a[0] - e, a[1] - h, a[0] + e, a[1] + h])) {
					for (var q in e)
						if (e.hasOwnProperty(q) &&
							...
							if (k = h.fc(), k instanceof g.Aa.Ng)
								if (this.Aj) {
									l = this.g.Em;
									l instanceof Array && (l = "number" === typeof h.ib.style && l[h.ib
										.style] ? l[h.ib.style] : l[0]);
						...
						.H(l[0], l[1]), m = new g.H(a[0], a[1]), k = k.get("radius"), "px" === h.get(
							"unit") ? m.He(l) / Math.pow(2, 20 - this.zoom) < k && c.push(h) : m.He(l) *
						Math.cos(h.get("center").Q * Math.PI / 180) <= k / this.Dq * Math.pow(2, 20 -
							this.zoom) && c.push(h);
					else if ("AMap.Text" == h.Vp) l = h.get("params"), l.visible && h.fa && g.f.JD(d, h
						.fa, "amap-markers") && c.push(h);
					else {
						if (l = h.get("params"), l.visible && h.fa)
							if (l.shape)
								for (k = k.za, s = l.Tp % 360, u = [a[0], a[1]], s && (v = (a[0] -
									...
									.offset.x * this.T, r = l.offset.y * this.T, m = g.I.SP([
										[u[0] - m - p, u[1] - n - r],
										[u[0] - p, u[1] - r]
					...
					} else k.Ud ? k.Ud(a) && c.push(h) : k.Gy && 1.8 * k.Gy(a) <= h.get(
						"strokeWeight") *
						this.T && c.push(h);
					this.Aj ? c.sort(function(a, b) {
						...
						return a.get("isTop") ? -1 : b.get("isTop") ? 1 : a.get("zIndex") > b
							.get("zIndex") || a.get("zIndex") === b.get("zIndex") && a.hm > b
							.hm ? -1 : 1
					});
					b(c, f)
				} else b([], f)
	...
	g.M.Sb = g.da.extend({
		...
		lT: function(a) {
			this.Ee = a || g.a.Yk("ff" + this.e.Ee.slice(1))
		},
		nq: function(a, b, c, d, e) {
			...
			for (var h = b.length, k = [], l = 0, m, n = [], p = 0; p < h; p += 1) m = b[p], (
					m instanceof g.q.hd || "AMap.LabelLayer" === m.CLASS_NAME) &&
	...
	g.V2 = {
		...
		vra: function(a) {
			...
			c.Ub(a.nodes, function(a) {
				!1 !== a.value && null !== a.value && (e[a.zoom] = g.o.Cc + "://" + a.value, d.push(
					a.zoom))
			});
			return function(a) {
				a = c.xb(a, 1);
		...
		cra: function(a) {
			...
			return function(a) {
				...
				if (void 0 === e[a]) {
					var k = b.mD(a, d, e);
					e[a] = f && "none" !== f && k.cK !== k.Iz && k.Nq !== k.YD ? c.H4(k.Nq, k.YD, (a - k
						.Iz) / (k.cK - k.Iz), f) : k.Nq
				}
				return e[a]
			}
		...
		wqa: function(a, b, c) {
			...
			e.Ub(a.nodes, function(a) {
				a.value && (h[a.zoom] = e.ima(a.value, c ? "rgba" : "webgl"), f.push(a.zoom))
			});
			return function(a) {
				var b = null;
				a = e.xb(a, 1);
				if (void 0 === h[a]) {
					var b = d.mD(a, f, h),
						n = b.Nq;
					if (k && "none" !== k && b.Iz !== b.cK && b.Nq.join("") !== b.YD.join(""))
						for (var n = n.slice(0), p = (a - b.Iz) / (b.cK - b.Iz), q = 0, r =
								b.YD.length; q < r; q++) n[q] = e.H4(b.Nq[q], b.YD[q], p, k);
					h[a] = n
				}
				b = h[a];
		...
		Dz: function(a, b, c, d) {
			...
			for (f in c)
				if (c.hasOwnProperty(f)) {
					...
					} : d.call(this, b[h], c[f])) : e.Dsa && (a[f] = !0)
				}
		},
		Tr: function(a, b) {
			for (var c = [], d = 0, e = a.length; d <
				e; d += 2) {
				var f = 0,
					f = "str" === b ? g.a.xb(parseInt(a.substr(d, 2), 16) / (0 === d ? 255 : 1), 3) : g.a
					.xb(parseInt(a.substr(d, 2), 16) / 255, 3);
				c.push(f)
			}
		...
		D7: function(a, b, c, d) {
			var e = {},
				...
				h = [
					...
					["textStrokeColor", {
						...
						tya: "textStrokeOpacity"
					}],
					["backgroundColor", {
						backgroundColor: "backgroundColor"
					}, {
						rma: "backgroundOpacity"
					}]
				],
				k = {
					fontSize: "fontSize"
			...
			if (a.styles) {
				a = a.styles;
				this.Dz(e, a, f, this.oqa, {
					Dsa: !0
				});
				this.Dz(e, a, k, this.p4, {
					Ssa: !0
				});
				this.Dz(e, a, l, this.p4, {
					Ssa: !0
				});
				k = 0;
				for (l = h.length; k < l; k++) {
					var m = h[k];
					a[m[0]] ? this.Dz(e, a, m[1], this.wqa, {
						Esa: !0
					}) : this.Dz(e, a, m[2], this.cra)
				}
				a.texture && (this.Dz(e, a, {
						Ja: "texture"
					}, this.vra),
			...
			if (a)
				for (var e in a)
					if (a.hasOwnProperty(e) && g.a.kk(a[e], "object")) {
						...
						var h = e;
						c && (h = c + ":" + e);
						if (f.detailedType) this.D7(f, b, h), this.CT(f.detailedType, b, h, f);
							...
							if (e.hasOwnProperty(f)) {
								...
								if (h) {
									...
									for (var k in h) h.hasOwnProperty(k) && void 0 !== h[k] && (c[d][f][
										k] = {}, h[k].Ye ? (b(h[k].Ye) ? c[d][f][k].Ye = h[k].Ye(a) : c[
												d][f][k].Ye = h[k].Ye, b(h[k].canvas) ? c[d][f][k]
		...
		styleChanged: function() {
			if (this.e.D.Ci) {
				...
				this.fl.SA || (this.fl = g.a.bind(this.fl, this), this.lq = g.a.bind(this.lq, this), this.fl
					.SA = !0);
				var b = g.a;
				if (a) {
					var c = {};
				...
				var d, e, f, h, k;
				this.be && (d = this.be[30001] && this.be[30001][1], e = this.be[30001] && this.be[30001][
					2], f = this.be["00001"] && this.be["00001"][1], h = this.be["00001"] && this.be[
						"00001"][2], k = this.be[50001] && this.be[50001][1]);
				var l,
					m, n, p, q, r, a = this.Hj;
				if (d) {
					c = "rgba(0, 0, 0, 0)";
					if (d.visible) {
						var s = this.lq(b.D8(this.e.Ee.substr(1)), d.opacity, d.color, !0, a);
						s && (c = this.Dt(s, d.visible, "rgba(0, 0, 0, 0)"), s = this.fl(b.qp(this.e.Ee
							.substr(1)), d.opacity, d.color, !0, a), l = this.Dt(s, d.visible))
					}
					this.e.Pu = c
				} else this.e.Pu = "";
				e && e.visible && (m = this.fl(b.qp(this.e.MH.substr(1)), e.opacity, e.color, !0, a), m =
					this.Dt(m, e.visible));
				f && f.visible && (n = this.fl(b.qp(this.e.qu.substr(1)), void 0, f.color, !0, a), n = this
					.Dt(n, f.visible), p = this.Dt(n, f.visible));
				h && h.visible && (d = h.color, !d && f && f.color && (d = f.color), p = this.fl(b.qp(this.e
					.qu.substr(1)), void 0, d, !0, a), p = this.Dt(p, h.visible));
				k && (k.visible ? (q = this.fl(b.Yk(this.e.XF[0]), void 0, k.fillColor, !0, a), q = this.Dt(
						q, k.visible), r = this.fl(b.Yk(this.e.XF[1]), void 0, k.strokeColor, !0,
					a), r = this.Dt(r, k.visible)) : (q = [1, 1, 1, 0], r = [1, 1, 1, 0]));
				this.lT && this.lT(l, m, n, [q, r], p);
				this.t$ ? this.t$(this.be) : this.set("display");
				delete this.em;
				this.yV(a)
			}
		},
		...
		fl: function(a, b, c, d, e) {
			if (a) {
				if (b) return c = b, "function" === typeof b && (c = b(e)), [a[0], a[1], a[2], g.a.xb(c,
				3)];
			...
			if (f = this.sD(b, e))
				if ("function" === typeof f.visible && !f.visible(e) || !1 === f.visible) h = "";
					...
					var h = 1,
						k = "";
					if (c)
						if (f.fillColor || f.me) h = f.me, k = f.fillColor;
						else {
							if (f.color || f.opacity) h = f.opacity, k = f.color
						}
					else if (f.strokeColor || f.qb) h = f.qb, k = f.strokeColor;
		...
		Py: function(a, b, c, d, e, f) {
			...
			r && ("function" === typeof r.visible && !r.visible(f) || !1 === r.visible || "function" ===
				typeof r.NU && !r.NU(f) || !1 === r.NU ? (n = m = !1, h = k = l = "") : (h = this.lq(a,
						r.qya, r.pya, !1, f), k = this.lq(b, r.tya, r.sya, !1, f), l = this.lq(c, r.rma,
						r.backgroundColor, !1, f), m = "function" === typeof r.wk ? r.wk(f) : r.wk, r
			...
			f && (h = this.jv(h || a), k = this.jv(k || b), l = this.jv(l || c), q = 1 - 1.6 * this.AD, n =
				m = !0);
		...
		Oy: function(a, b, c, d, e) {
			...
			d = d ? this.lq : this.fl;
			var l = e || this.Hj;
			if (f = this.sD(c, e)) "function" === typeof f.visible && !f.visible(l) || !1 === f.visible ?
				h = k = "" : (h = d(a, f.me, f.fillColor, !1, l), k = d(b, f.qb, f.strokeColor, !1, l));
	...
	g.M.canvas.Sb = g.M.Sb.extend({
		...
		pc: function(a) {
			var b = this.e.P3();
			b && this.XT !== b && this.e.D.Ci && (this.e.T8(b), this.XT = b);
			...
			this.T = b.T;
			if (!this.Na || 1E4 < Math.abs(b.mb.x - this.Na.x) / this.T || 1E4 < Math.abs(b.mb.y - this
					.Na.y) /
				this.T) this.Na = b.mb;
			this.Na.x - b.mb.x < -g.a.Fa / 2 ? this.Na = new g.H(this.Na.x + g.a.Fa, this.Na.y) : this
				.Na.x - b.mb.x > g.a.Fa / 2 && (this.Na = new g.H(this.Na.x - g.a.Fa, this.Na.y));
			for (var h = 0; h < c.length; h += 1) {
				var k = c[h],
					l = this.Bs(k),
					m = c[h].ne();
				if (l && l.g)
					if (!m.visible || k.ZD || m.Za[0] > b.zoom || m.Za[1] < b.zoom || k.ha && 0 === k.ha
						.length) {
						if (l = l.vj())
							if (l.length)
					...
					var k = l.vj(),
						n, p, q = l.transform;
					if (!q || !k || l.Di && !this.e.D.Ra) c[h].zj && k.parentNode !== this.K && (this.K
						.appendChild(k), c[h].Ob = k);
					else {
						c[h].Ob = k;
						k.length || (k = [k], q = [q]);
						for (var r = 0; r < k.length; r += 1)
							if (n = k[r], p = q[r], !p.bz) {
								var s = p.translate.x,
									u = p.translate.y;
								c[h].HJ || (s = g.a.xb(s, 2), u = g.a.xb(u, 2));
								var v = p.scale;
								1E-5 > Math.abs(s) && (s = 0);
								1E-5 > Math.abs(u) && (u = 0);
								var w = [];
								w.push("position:absolute");
								w.push("z-index:" + (p.Ik || c[h].get("zIndex")));
								c[h].YC ? (w.push("top:" + Math.floor(f / 2 + u) + "px"), w.push(
									"left:" +
									Math.floor(e / 2 + s) + "px")) : n.N5 ? (w.push("height:" + n
										.height * v + "px"), w.push("width:" + n.width * v + "px"),
									w.push("top:" + (f / 2 - u * v) + "px"), w.push("left:" + (e /
										2 - s * v) + "px")) : (1 !== v && (w.push(g.f.qt[g.f.qg] +
									"-origin:" + s + "px " + u + "px"), w.push(g.f.qt[g.f
									.qg] + ":scale3d(" + v + "," + v + ",1)")), w.push("top:" +
									Math.floor(f / 2 - u) + "px"), w.push("left:" + Math.floor(
									e / 2 - s) + "px"), w.push("display:block"), l.kl && (w
									.push("height:" + n.height + "px"), w.push("width:" + n
										.width + "px")));
								l.HJ || 1 === m.opacity || "number" !== typeof m.opacity || w.push(g.f
									.r4(n,
										m.opacity));
			...
			k = this.e.Ya.q;
			c = this.e.Ya.B;
			g.f.qg && "number" === typeof b.rotation && 0 !== b.rotation ? (a.style[g.f.qg + "Origin"] =
				e / 2 + "px " + f / 2 + "px", a.style[g.f.qg] = "rotate(" + b.rotation + "deg)", a
		...
		IJ: function(a, b) {
			...
			for (var c = 0, d = a.Yl.length; c < d; c++)
				if (g.a.ka(b, "region" === a.Yl[c] ? "bg" : a.Yl[c])) return !0;
			return !1
		},
		zoomChanged: function() {
			var a = this.e.get("zoom");
			this.Hj = "vw" === this.e.D.De.baseRender ? g.a.xb(a, 1) : Math.round(a);
			this.be && this.yV(this.Hj)
		}
	});
	g.M.Ui = g.M.Zb.extend({
		A: function(a, b) {
			...
			this.oa = new g.pg(c);
			var e = this;
			this.oa.kK.M1(function(a) {
				e.dB(a)
			});
			this.oa.zC = function(a) {
				return a.pb ? (a.pb.Tg -= 1, 0 == a.pb.Tg && (a.Cv = !1), delete a.pb, !0) : a.Cv ?
					a.Tg ? !1 : !0 : !0
			};
			this.jd = 1;
			this.ao = 50;
			this.rX = !0;
			this.g.oa = this.oa;
			this.rm = new g.yF(6, null, a.WQ);
			new g.yF(5, null, a.WQ)
		},
		Jq: function() {
			this.clear();
			this.Jg = null;
			this.oa.clear();
			this.oa.zC = null;
			this.oa = this.oa.kK.TF = null;
			this.Lc && (this.Lc.G("tiles", this.dE, this), this.Lc.G("ack", this.cE, this), this.Lc.G(
				"disable", this.aE, this), this.Lc = null);
		...
		yh: function(a, b, c) {
			function d(b) {
				a.loaded = !0;
				e.g && (a.status = "loaded", a.Ba = !0, a.ld = b, e.set("display", 0), "function" ===
					typeof c && c())
			}
			var e = this;
			a.status = "loading";
			...
			for (var f = 0; f < a.length; f += 1) {
				...
				if (d) {
					if (k = c + "/" + k + "/" + h, (h = this.oa.get(k)) && "loaded" == h.status)
						continue
				} else h = new g.rr(c, k, h), k = h + "", h = new g.sb(h);
				...
				var e,
					f, h, k, l, m, n, p = function() {
						...
						for (e = a.length - 1; 0 <= e; e -= 1)
							for (f = a[e], h = [], k = [], f.YT = h, f.Ov = k, l = f.length - 1; 0 <=
								l; l -= 1) m = f[l], n = m.ta, c.g.e.Se.PE(n.x, n.y, n.z, function() {
								var c = l;
								return function(e) {
		...
		Gn: function(a) {
			var b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : !1;
			if ((!this.lk || !this.hf && !this.he) && a.length)
				if (this.JK) this.aK = !0;
				else {
					for (var c =
							a.length - 1; 0 <= c; c -= 1) {
						var d = a[c];
						if (d.length)
							for (var e = Math.pow(2, 20 - d[0].ta.z), c = d.length - 1; 0 <= c; c--) {
								...
								if (10 > h.z) {
									var k = this.lJ(f);
									k && (f.pb = k, f.status = "loaded", f.Ba = !0, k.Tg += 1, f.bl = (h
						...
						for (var c = a.length - 1; 0 <= c; c -= 1) {
							...
							if (d.length)
								if (l.Ei) {
									...
									l.jw(d, l.kl ? 1 : 0);
									for (var f = 0,
											h = 0; f < d.length;) l.WS(d.slice(10 * h, 10 * h +
										10), e, b), f += 10, h += 1
								} else
									for (e = function() {
											var a = d.length;
										...
										}(), l.jw(d), l.Aq += d.length, f = d.length - 1; 0 <=
										f; f -= 1) l.yh(d[f], l.rm, e)
						}
					})
				}
		},
		...
		jw: function(a, b) {
			if (a.length) {
				var c =
					this.mb.nd(this.Fd << 20 - a[0].ta.z),
					d = Math.floor(c.x),
					e = Math.floor(c.y);
				a.sort(function(a, c) {
					var k = a.ta,
		...
		ip: function(a, b) {
			...
			this.gb = "AMap.MapBox" == this.g.S.CLASS_NAME ?
				Math.max(2, this.oe - g.o.Wn) : !1 === this.Ei && !this.g.pS && this.g.ja ? this.oe +
				1 : this.oe;
			...
			this.Hg = c.Hg;
			c = a.P.Ha;
			this.qk = this.uy(c, b.I);
			this.Jw = c.P$ ? this.uy(c.P$, b.I) : null;
			var c = this.qk,
				d = this.Ha.H9,
				e = null,
				e = d < this.zoom && this.Jw ? this.Jw : c,
				f = [],
				h = [],
				k, l = [],
				m = [],
			...
			for (q = m.length - 1; 0 <= q; q -= 1)
				if (k = m[q], !(k.kx < b.opacity))
					if (p.z =
						k.ta.z, p.x = k.ta.x, p.y = k.ta.y, p.z === this.gb) s[p + ""] |= 16;
					else if (p.z < this.gb) {
				if (s[p + ""] |= 64, this.$i)
					for (x = this.gb - p.z, v = Math.max(c.Jc, p.x << x), r = Math.min(c.Ic, (p.x + 1 <<
							x) - 1), w = Math.max(c.hc, p.y << x), t = Math.min(c.tc, (p.y + 1 << x) -
							1), p.z = this.gb, x = v; x <= r; x += 1)
			...
			for (x = e.Jc; x <= e.Ic; x += 1)
				for (p.x = x, y = e.hc; y <= e.tc; y += 1) p.y = y, k = this.Vy(p), this.cu(k), v = !1,
					k.Ba ? (k.fe = this.fe, this.xv(c, x, y) && (m.push(k), this.Jl && (k.jd !== this
						.jd || 1 > k.kx) && (v = !0))) : (q = !1, this.xv(c, x, y) && (v = !0), k
						.status && !k.Je || this.oe !== d || this.Jw && !this.xv(this.Jw, x, y) || l
						.push(k)), v && n.push(k);
						...
						if (x = d[q], v = s[x.key], v & 7)
							for (v = x.ta.x << 1, w = x.ta.y << 1, x = 1; 0 <= x; x -= 1)
								for (p.x = v + x, y = 1; 0 <= y; y -= 1) p.y = w + y, E = p + "", t =
									this.oa.rK(E), s[E] & 5 && t && t.Ba ? (t.KB = !0, t.fe = this.fe, m
										.push(t), this.cu(t)) : n.push(new g.sb(p.eb()));
					m.length && (e = !0, f.push(m))
				}
				n = l
			}
			if (!e && this.$i)
				for (x = !f.length || this.kl ? b.Za[0] : Math.max(b.Za[0], this.gb - 2), Math.max(x,
						this.gb - this.eha), r = this.gb - 1; n.length && r >= x; r -= 1) {
					m = [];
					y = {};
					d = n;
					n = [];
					for (q = d.length - 1; 0 <= q; q -= 1) k = d[q], p.z = r, p.x = k.ta.x >> 1, p.y = k
						.ta.y >> 1, k = this.Vy(p), y[k.key] || (y[k.key] = 1, v = !1, k.Ba && (!this
								.eja || s[k.key] & 64) ? (p.x = Math.min(c.Ic, Math.max(c.Jc, p.x <<
									this.gb - r)), p.y = Math.min(c.tc, Math.max(c.hc, p.y << this.gb -
									r)), p.z = this.gb, E = p + "", "number" === typeof u[E] && k.ta.z >
								u[E] ? v = !0 : k.KB = !0, k.fe = this.fe, m.push(k), this.cu(k)) :
							v = !0, v && n.push(k));
					m.length && f.push(m)
				}
			this.gV = h;
		...
		JR: function(a, b) {
			for (var c = [], d = this.e.D.getCoordsBoundByZoom(a), d = this.uy(d, b, a), e = d.Jc; e < d
				.Ic; e++)
				for (var f = d.hc; f < d.tc; f++) {
					var h = [a, e, f].join("/");
					this.oa.Nd(h) || c.push(new g.sb(new g.rr(a, e, f), !0))
				}
			return c
		},
		OX: function() {
			var a = this.e.D;
			return a.Y7 && a.get("preloadMode") && 200 <= this.oa.Kp && this.g.S.wq() && "stable" !=
				this.Hf && this.ay && this.ay() && this.zoom !== this.gb
		},
		oE: function(a, b) {
			var c = b.I,
				d = b.Za;
			if (this.OX() && this.gb >= d[0] + 1) {
				var d = [],
					e = null,
	...
	g.M.ce.Ui = g.M.Ui.extend({
		...
		$v: function(a) {
			var b = Math.pow(2, a.P.zoom - this.Df),
				c = a.P.mb.bb(this.Ls).nd(this.ym);
			this.transform = {
		...
		Nz: function(a, b) {
			...
			this.Oe(a);
			this.wg && !this.g.Ra && (c = this.g, c.Ra = !0, c.Ld ? c.qa("renderComplete") : (c.Ld = !0,
				c.qa("complete")))
		},
		pc: function(a, b) {
			this.up = a.up;
		...
		Zv: function() {
			for (var a = this.Ob.childNodes, b = a.length - 1; 0 <= b; b -= 1) a[b] && a[b].jd !== this
				.jd && this.Ob.removeChild(a[b])
		},
		sE: function(a, b) {
			...
			for (d = a.length - 1; 0 <= d; d -= 1)
				if (f = a[d], f.length) {
					...
					for (var r = f.length - 1; 0 <= r; r -= 1) {
						...
						m = n.ta;
						var c = !0,
							u = (new g.H((m.x << 20 - e) * this.Fd, (m.y << 20 - e) * this.Fd)).bb(this
								.Na),
							u = u.nd(this.Hg);
						u.x = g.a.xb(u.x, 1);
						u.y = g.a.xb(u.y, 1);
						var v = 1;
						if (!n.nY || this.rX && n.jd !== b) n.nY = this.currentTime;
						this.Jl && !n.KB ? (v = Math.max(0, Math.abs(m.z - this.zoom) - 1), v = Math
							.min(1, (this.currentTime - n.nY) / (1 / Math.pow(1.32, v) * this.ao)),
							1 !== v && (this.ze = !0)) : n.KB = !1;
						n.jd = this.jd;
						n.kx = v;
						n.Ba ? (s = n.ld, !s && n.pb && n.pb.ld && ("CANVAS" === n.pb.ld.tagName ? (s =
							document.createElement("canvas"), s.width = n.pb.ld.width, s
							.height = n.pb.ld.height, s.getContext("2d").drawImage(n.pb.ld,
								0, 0, s.width, s.height), n.ld = s, n.pb.Tg -= 1, n.pb =
							null, n.bl = 0) : "IMG" === n.pb.ld.tagName ? (s = document
							.createElement("img"), s.src = n.pb.ld.src, n.ld = s, n.pb.Tg -=
							1,
							n.pb = null, n.bl = 0) : s = n.pb.ld), 0 !== v && s && (this.i4(s, u
								.x, u.y, p, p, v, m.z), s.parentNode !== this.Ob && (g.l.Ai &&
								"overlayer" === this.g.get("type") && (s.style.display =
								"none"), this.ev.appendChild(s)), s.jd = this.jd, n.oe = this
							.oe, h.push(n))) : n.fe = null
					}
					e = !0
				} this.lk && k && (r = l.sort().join(";"), k.JS = r, r !== this.ue.JS && (this.ue = k));
	...
	window.CanvasRenderingContext2D && (window.CanvasRenderingContext2D.prototype.CQ = function(a, b, c, d, e) {
		...
		c = h / k;
		e.Fg = 0;
		for (var l = [], f = this.uI, m = 0, n = 0, p = !1, q = h = 0; q < e.length; q += 1) e.Fg += e[q],
			l[q] = {
				cD: e[q] * d,
				dD: e[q] * c,
				hz: h += e[q]
			}, f -= e[q], 0 > f && !p && (m = q, n = -f, p = !0);
		for (p = 0; n + p <= k;) n < e[m] ? (f = n * d, h = n * c) : (f = l[m].cD, h = l[m].dD), a += f,
			b += h, this.JE ? this.moveTo(a, b) : this.lineTo(a, b), p += n, this.JE = !this.JE, n = e[(m +
					1) %
	...
	}, window.CanvasRenderingContext2D.prototype.Aoa = function(a, b, c, d) {
	...
	g.M.Le.Hl = g.M.Ui.extend({
		...
		wt: function(a, b) {
			...
			var c = !1;
			if (!this.Na ||
				500 < Math.abs(this.nb.x - this.Na.x) / this.T || 500 < Math.abs(this.nb.y - this.Na
				.y) / this.T) c = !0;
			if (c || this.zoom << 0 !== this.zoom || this.Df !== this.zoom) this.Na = this.nb, this.Df =
				this.zoom
		},
		mv: function(a) {
		...
		Zv: function() {
			if (this.Th && this.Th)
				for (var a in this.Th)
					if (this.Th.hasOwnProperty(a)) {
						var b = this.Th[a];
		...
		pc: function(a, b) {
			...
			c = c.yn(e);
			for (d in c) c.hasOwnProperty(d) && (c[d].fe = this.fe, c[d].i6 = this);
			this.Zv(c);
		...
		Oe: function() {
			...
			this.transform = {
				translate: this.Na.bb(this.nb).nd(this.T),
				scale: a,
				rotate: 0
			}
		}
			...
			for (f in a)
				if (a.hasOwnProperty(f)) {
					...
					if (h.fa) k = h.fa;
						...
						m && k.appendChild(m);
						n && k.appendChild(n);
						p && !1 !== m.AM && k.appendChild(p);
						h.fa = k;
						h.Vg = m;
						if (n = l.title) m.title = n;
						this.g.nm = !0; - 1 === g.a.indexOf(this.g.bh, h) && this.g.bh.push(h);
						h.se = !0
					}
					var p = l.offset,
						q = p.x,
					...
					if ("AMap.Text" == h.Vp || "AMap.Marker" == h.Vp) {
						if (w = v = 0, k.parentNode !== this.ql && d && (m = !0, d[f] = h, e = !1), !
							m) {
					...
					if (!m)
						if (h.se) {
							...
							E.push("top:" + r + "px");
							E.push("left:" + q + "px");
							E.push("z-index:" + (l.U5 ? this.g.fr + 10 : l.zIndex));
							if (!g.l.Ve) {
								r = v;
								q = w;
								if ("AMap.Marker" == h.Vp) {
						...
						} else if (h.eba || this.zoom << 0 !== this.zoom || h.zoom !== this.zoom || k
						.parentNode !== this.ql || h.Na !== this.Na) x = this.Mu(h.W.za), h.Na = this
						.Na, y = l.pF,
	...
	Tc.Uf && Wc.push("touch");
	Tc.ba || Wc.push("mouse");
	Tc.dL && (Wc.push("vectorlayer", "overlay"), Tc.sp ? Wc.push("wgl") : Wc.push("cgl"));
	if (Uc) {
		for (var Xc = [], Yc = Uc.split(","), Jc = 0; Jc < Yc.length; Jc += 1) {
			var Zc = Yc[Jc];
			gc[Zc] && Xc.push.apply(Xc, gc[Zc]);
			Xc.push(Zc)
		}
		Wc = Wc.concat(Xc)
	}
	...
	if (Tc.Kv) {
		var $c = !0,
			...
			bd = [];
		try {
			for (var Jc = 0, cd = Wc.length; Jc < cd; Jc++) {
				var dd = JSON.parse(localStorage.getItem("_AMap_" + Wc[Jc]));
				if (dd && dd.version === Nc.Ek) ad.push(dd.script), dd.css && bd.push(dd.css);
				else {
					ad = void 0;
					$c = !1;
					break
	...
	if (Vc)
		for (Jc = 0; Jc < Wc.length; Jc += 1) g.ub.SC(Wc[Jc]).status = 1;
	else Nc.OJ = !1, id();

	function jd() {
		for (var a = fa.getElementsByTagName("script"), b, c = 0; c < a.length; c += 1)
			if (0 === a[c].src.indexOf(Nc.Hb + "/maps?")) {
				b = a[c];
				break
			} return Nc.Nc || b && b.async
	}

	function id() {
		var a = Nc.Hb + "/maps/modules?v=" + Nc.Xl + "&key=" + Nc.key + "&vrs=" + Nc.Ek + "&m=" + Wc.join(",");
		jd() ? kd(a) : (fa.write('<script crossorigin="anonymous" id="amap_plus_js" src="' + a +
	...
	function fd() {
		...
		b.type = "text/css"; - 1 === Nc.Hb.indexOf("webapi.amap.com") && (a = a.replace(/webapi.amap.com/gi, Nc.Hb
			.split("://")[1]));
		"https" === Nc.Cc && (a = a.replace(/http:/gi, "https:"));
		if (b.styleSheet) {
			var c = function() {
				try {
...
})(["ffdb1e8cf24f46b5747e80a049ae4aee", [105.28976, 28.160225, 110.199858, 32.201187, 106.504962, 29.533155],
	"https://webapi.amap.com", 1, "1.4.20", null, "500000", "", true, false, false, true,
	"20220726011500-20201123-1", false, "B", "3_22_11_01_00", "https", "webapi.amap.com"
])
